...
measured, and a same-night control inverted it. A matched-size random
fill resurrected a dead core about as well as the verbal-branch fill
(51/36/48 versus 55 of 120), which read as coverage-not-class — but
that random pool was itself about 45 percent verbal-branch experts.
Fills that exclude the verbal branch at the same recall score 0 and 7
of 120, against 16 to 55 for fills that include it, and a recall
