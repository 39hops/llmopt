...
| The interaction law (diversity-per-step is the binding resource of single-pass training; epochs buy back what correlated batches spend) | Small-batch/gradient-diversity generalization (Keskar et al. 2017 sharp minima; gradient diversity, Yin et al. 2018); curriculum/data-ordering lineage | [ORIGINAL: the full 2x2 measured at d256 (mixed/sorted x hot/cool: 53/57/45/45) — homogeneity -12 at one pass, ~0 with revisits; packed-homogeneity 07-16 precedent as the sibling; Muon orthogonalized-update transplant FAILED to buy it back in-optimizer (10/34 v 45)] |
