...
Census: UNCITED 163, library 166, reproduce-pinned 9, results-cited 125, spec-cited 50, cited-but-library 113

## scratch/

| family | file | class | cited by | doc citations | refs |
|---|---|---|---|---|---|
| absorb | absorb_1e5.py | UNCITED | — | — | — |
| adjudicate | adjudicate_zx.py | library | — | — | 1 |
| anatomy | anatomy.py | library | RESULTS, specs | RESULTS×5, specs×4 | 3 |
| attractor | attractor_census.py | library | RESULTS | RESULTS×1 | 1 |
...
| calib | calib_dist_birth.sh | library | specs | specs×4 | 1 |
| calib | calib_probe.py | library | RESULTS, specs | RESULTS×1, specs×11 | 3 |
| calib | calib_snap_gates.sh | spec-cited | specs | specs×5 | — |
| callspan | callspan_arms.py | UNCITED | — | — | — |
| capacity | capacity_meter.py | library | RESULTS, specs | RESULTS×1, specs×2 | 4 |
...
| ckpt | ckpt_inventory.py | library | specs | specs×2 | 1 |
...
| complex | complex_model.py | library | specs | specs×1 | 7 |
...
| detbwd | detbwd_gravmoe.py | library | RESULTS, specs | RESULTS×2, specs×27 | 8 |
...
| ex1 | ex1_swap.py | library | RESULTS, specs | RESULTS×2, specs×1 | 1 |
| ex2 | ex2_build.py | results-cited | RESULTS, specs | RESULTS×1, specs×1 | — |
| ex3 | ex3_build.py | results-cited | RESULTS, specs | RESULTS×2, specs×1 | — |
...
| farm | farm_dist_rows.py | library | RESULTS, specs | RESULTS×1, specs×4 | 1 |
...
| gate | gate_ckpt.py | library | RESULTS, specs | RESULTS×3, specs×11 | 38 |
| gate | gate_ckpt_cuda.py | library | — | — | 12 |
| gate | gate_cplx.py | library | specs | specs×1 | 1 |
| gate | gate_pp.py | library | — | — | 1 |
| gate | gate_prefix.py | library | RESULTS | RESULTS×1 | 1 |
| gate | gate_rarity.py | library | RESULTS | RESULTS×1 | 10 |
...
| gt2 | gt2_jaccard.py | library | REPRODUCE, RESULTS, specs | REPRODUCE×1, RESULTS×3, specs×4 | 12 |
...
| gt5 | gt5_union_keep.py | reproduce-pinned | REPRODUCE, RESULTS | REPRODUCE×1, RESULTS×1 | — |
...
| gt7 | gt7_coverage_rederive.py | library | RESULTS, specs | RESULTS×4, specs×2 | 1 |
| gt7 | gt7_draw.py | library | specs | specs×2 | 1 |
| gt7 | gt7_run.py | results-cited | RESULTS, specs | RESULTS×7, specs×2 | — |
| head | head_autopsy.py | library | — | — | 1 |
| head | head_census.py | library | specs | specs×2 | 1 |
| holdout | holdout_gate.py | library | specs | specs×1 | 1 |
| holdout | holdout_v2.py | library | — | — | 2 |
| hot | hot_chain.sh | library | RESULTS | RESULTS×2 | 1 |
...
| k3 | k3_expert_demo.py | library | RESULTS, specs | RESULTS×4, specs×2 | 4 |
...
| lyap | lyap_compare.py | library | RESULTS, specs | RESULTS×1, specs×1 | 2 |
| lyapunov | lyapunov_birth.sh | UNCITED | — | — | — |
| mac | mac_day_chain.sh | UNCITED | — | — | — |
| make | make_altpairs.py | library | RESULTS | RESULTS×1 | 1 |
...
| metabolic | metabolic_hot.py | library | RESULTS | RESULTS×1 | 1 |
| metabolic | metabolic_v3.py | spec-cited | specs | specs×1 | — |
| metabolic | metabolic_v4.py | UNCITED | — | — | — |
| metabolic | metabolic_v5.py | library | — | — | 2 |
| metallicity | metallicity_diets.py | library | RESULTS | RESULTS×2 | 1 |
| metallicity1 | metallicity1.sh | results-cited | RESULTS | RESULTS×2 | — |
| moe | moe_gt1.py | library | REPRODUCE, RESULTS, specs | REPRODUCE×4, RESULTS×4, specs×4 | 5 |
| moe | moe_gt1_arm2.py | library | REPRODUCE, RESULTS, specs | REPRODUCE×6, RESULTS×6, specs×4 | 5 |
...
| night | night_45m_union.sh | library | RESULTS, specs | RESULTS×2, specs×1 | 2 |
...
| night | night_zx2.sh | library | RESULTS | RESULTS×1 | 1 |
| night | night_zx3.sh | results-cited | RESULTS | RESULTS×1 | — |
| night | night_zx45_x2.sh | library | RESULTS | RESULTS×1 | 1 |
| night2 | night2_mac.sh | library | RESULTS | RESULTS×1 | 1 |
...
| oracle | oracle_worker.py | library | REPRODUCE, RESULTS, specs | REPRODUCE×1, RESULTS×2, specs×1 | 6 |
...
| ozaki | ozaki_rung2bc.py | library | RESULTS | RESULTS×1 | 4 |
...
| p4 | p4_arms_0801.sh | library | RESULTS, specs | RESULTS×3, specs×11 | 2 |
...
| pack | pack_decode.py | library | RESULTS | RESULTS×4 | 2 |
...
| pincer | pincer_r1_probe.py | library | RESULTS | RESULTS×1 | 1 |
| pincer | pincer_r1b_labels.py | library | RESULTS, specs | RESULTS×1, specs×1 | 2 |
...
| poly4 | poly4_pipeline.sh | library | specs | specs×1 | 1 |
| poly4 | poly4_watcher.sh | UNCITED | — | — | — |
| poly5 | poly5_pipeline.sh | library | specs | specs×1 | 1 |
...
| rank | rank_read.py | library | specs | specs×2 | 1 |
| rat | rat_deploy.py | library | RESULTS, specs | RESULTS×1, specs×5 | 3 |
| rat | rat_repair.py | library | — | — | 1 |
| rational | rational_snap.py | library | RESULTS, specs | RESULTS×1, specs×1 | 6 |
...
| rev4 | rev4_zx45.py | library | RESULTS | RESULTS×1 | 1 |
...
| series | series_probe.py | library | specs | specs×5 | 13 |
| snap | snap_alloc.py | library | specs | specs×2 | 1 |
| snap | snap_anatomy.py | results-cited | RESULTS | RESULTS×1 | — |
| softprompt | softprompt_sampler_probe.py | spec-cited | specs | specs×1 | — |
| softprompt1 | softprompt1.py | library | RESULTS, specs | RESULTS×4, specs×2 | 2 |
| softprompt1 | softprompt1.sh | results-cited | RESULTS | RESULTS×1 | — |
| soup | soup_gate.py | library | specs | specs×1 | 1 |
| ssm | ssm_star.py | library | RESULTS | RESULTS×1 | 2 |
...
| tenet | tenet_w1_bridge.py | library | RESULTS, specs | RESULTS×1, specs×1 | 1 |
...
| umoe | umoe_conserve.py | library | RESULTS | RESULTS×2 | 12 |
...
| wsl | wsl.sh | library | RESULTS, specs | RESULTS×10, specs×19 | 4 |
...
| family | file | class | cited by | doc citations | refs |
|---|---|---|---|---|---|
|  | __init__.py | library | RESULTS, specs | RESULTS×1, specs×4 | 1 |
...
| bench | bench_fused_ce.py | library | RESULTS | RESULTS×1 | 1 |
...
| bench | bench_metal_kernels.py | library | specs | specs×8 | 2 |
| bench | bench_mlx_integration.py | UNCITED | — | — | — |
| bench | bench_nnue.py | library | specs | specs×8 | 1 |
...
| bench | bench_proposer.py | library | specs | specs×9 | 1 |
| bench | bench_quant_schemes.py | library | RESULTS | RESULTS×1 | 1 |
| bench | bench_record.py | results-cited | RESULTS | RESULTS×1 | — |
| bench | bench_regret_resample.py | UNCITED | — | — | — |
| bench | bench_rotate_quantize.py | library | specs | specs×2 | 1 |
...
| bench | bench_step_tokens.py | library | RESULTS, specs | RESULTS×2, specs×7 | 70 |
...
| bench | bench_verify_fast.py | library | specs | specs×3 | 49 |
...
| bench | bench_zx_r5.py | library | RESULTS | RESULTS×1 | 3 |
...
| ckpt | ckpt_manifest.py | library | RESULTS, specs | RESULTS×3, specs×1 | 2 |
...
| gen | gen_catalog.py | library | RESULTS, specs | RESULTS×1, specs×1 | 1 |
| gen | gen_codemap.py | library | RESULTS, specs | RESULTS×1, specs×16 | 1 |
...
| gen | gen_index.py | library | specs | specs×6 | 1 |
| gen | gen_lake.py | library | RESULTS, specs | RESULTS×1, specs×1 | 1 |
...
| gen | gen_results_index.py | library | RESULTS, specs | RESULTS×2, specs×12 | 3 |
| gen | gen_scoreboard.py | UNCITED | — | — | — |
| gen | gen_syndrome_labels.py | library | RESULTS | RESULTS×1 | 1 |
| grow | grow_mathnative.py | library | specs | specs×1 | 2 |
| harvest | harvest_champion.py | UNCITED | — | — | — |
| harvest | harvest_frontier.py | spec-cited | specs | specs×1 | — |
| list | list_uncurated.py | spec-cited | specs | specs×5 | — |
| log | log_hygiene.py | library | RESULTS, specs | RESULTS×1, specs×2 | 1 |
...
| moe | moe_router_stats.py | library | RESULTS, specs | RESULTS×1, specs×2 | 4 |
...
| results | results_query.py | library | specs | specs×14 | 1 |
...
| step | step_grpo_micro.py | library | RESULTS, specs | RESULTS×5, specs×7 | 95 |
...
| train | train_calculus.py | library | specs | specs×6 | 5 |
| train | train_dispatcher.py | UNCITED | — | — | — |
| train | train_magic_estimator.py | library | RESULTS | RESULTS×1 | 8 |
| train | train_magic_llm.py | results-cited | RESULTS | RESULTS×1 | — |
| train | train_mathnative.py | library | RESULTS, specs | RESULTS×4, specs×7 | 84 |
| train | train_nnue.py | library | specs | specs×8 | 15 |
| train | train_proposer.py | spec-cited | specs | specs×5 | — |
| train | train_syndrome_decoder.py | library | RESULTS | RESULTS×1 | 1 |
| train | train_syndrome_policy.py | results-cited | RESULTS | RESULTS×1 | — |
| train | train_ternary.py | library | RESULTS, specs | RESULTS×1, specs×1 | 1 |
