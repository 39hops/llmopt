...
Census: UNCITED 228, library 73, reproduce-pinned 10, results-cited 361, spec-cited 89, cited-but-library 61
...
| mathworld0 | mathworld0.py | results-cited | RESULTS | RESULTS×6 | — | 17 |
...
| mathworld1 | mathworld1_actionfinal.py | results-cited | RESULTS | RESULTS×1 | — | 16 |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 26 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 46 |
...
| mathworld1 | mathworld1_axfixture.py | results-cited | RESULTS | RESULTS×2 | — | 6 |
...
| mathworld1 | mathworld1_cl1pop.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_cl1run.py | results-cited | RESULTS | RESULTS×1 | — | — |
...
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 38 |
...
| mathworld1 | mathworld1_svpchal.py | UNCITED | — | — | — | 6 |
| mathworld1 | mathworld1_svpchal2.py | UNCITED | — | — | — | 5 |
| mathworld1 | mathworld1_svpchalscore.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 34 |
...
| mathworld1 | mathworld1_svpdiet.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
| mathworld1 | mathworld1_svpdiet2.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
| mathworld1 | mathworld1_svpdiet3.py | results-cited | RESULTS | RESULTS×2 | — | 6 |
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×5 | — | 11 |
...
| mathworld1 | mathworld1_svpfoheld.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
| mathworld1 | mathworld1_svpfohrepl.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_svpforder.py | results-cited | RESULTS | RESULTS×2 | — | 7 |
...
| mathworld1 | mathworld1_svpnuisdesk.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
