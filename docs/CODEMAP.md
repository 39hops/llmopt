...
Census: UNCITED 227, library 73, reproduce-pinned 10, results-cited 342, spec-cited 89, cited-but-library 61
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 22 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 28 |
...
| mathworld1 | mathworld1_birth.py | results-cited | RESULTS | RESULTS×2 | — | 28 |
...
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 17 |
...
| mathworld1 | mathworld1_svpadj.py | results-cited | RESULTS | RESULTS×6 | — | 8 |
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 22 |
...
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 16 |
...
| mathworld1 | mathworld1_svpdiet3.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
...
| mathworld1 | mathworld1_svpgbirth16.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
