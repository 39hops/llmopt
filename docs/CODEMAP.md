...
| dfa | dfa_credit.py | library | RESULTS, specs | RESULTS×3, specs×3 | 17 | 1 |
...
| dfa | dfa_probe.py | library | RESULTS, specs | RESULTS×2, specs×1 | 11 | 1 |
...
| sg | sg_crosspos_desk.py | results-cited | RESULTS | RESULTS×5 | — | 1 |
