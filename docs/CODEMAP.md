...
Census: UNCITED 228, library 73, reproduce-pinned 10, results-cited 373, spec-cited 89, cited-but-library 61
...
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 51 |
...
| mathworld1 | mathworld1_prband.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
| mathworld1 | mathworld1_prband2branch.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_prband2desk.py | results-cited | RESULTS | RESULTS×2 | — | — |
...
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 44 |
...
| mathworld1 | mathworld1_svpchal.py | results-cited | RESULTS | RESULTS×2 | — | 8 |
| mathworld1 | mathworld1_svpchal2.py | UNCITED | — | — | — | 7 |
| mathworld1 | mathworld1_svpchalscore.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 39 |
...
| mathworld1 | mathworld1_svpdiet.py | results-cited | RESULTS | RESULTS×2 | — | 5 |
| mathworld1 | mathworld1_svpdiet2.py | results-cited | RESULTS | RESULTS×2 | — | 5 |
| mathworld1 | mathworld1_svpdiet3.py | results-cited | RESULTS | RESULTS×3 | — | 8 |
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×7 | — | 15 |
...
| mathworld1 | mathworld1_svpforder.py | results-cited | RESULTS | RESULTS×3 | — | 12 |
...
| mathworld1 | mathworld1_svpnuisdesk.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
