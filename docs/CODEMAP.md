...
Census: UNCITED 163, library 166, reproduce-pinned 9, results-cited 125, spec-cited 50
...
| anatomy | anatomy.py | library | RESULTS×5, specs×4 | 3 |
| attractor | attractor_census.py | library | RESULTS×1 | 1 |
| attractor | attractor_census2.py | results-cited | RESULTS×2, specs×1 | — |
...
| boundary | boundary_or_bulk.py | results-cited | RESULTS×3 | — |
...
| cal | cal_dk_probe.py | library | — | 1 |
| calib | calib_dist_birth.sh | library | specs×4 | 1 |
| calib | calib_probe.py | library | RESULTS×1, specs×11 | 3 |
| calib | calib_snap_gates.sh | spec-cited | specs×5 | — |
| callspan | callspan_arms.py | UNCITED | — | — |
| capacity | capacity_meter.py | library | RESULTS×1, specs×2 | 4 |
| ce | ce_gate_study.py | spec-cited | specs×2 | — |
| ce400 | ce400.py | library | — | 2 |
| ceiling | ceiling_probe_cuda.py | UNCITED | — | — |
| chain | chain_carry.py | library | — | 1 |
| champ | champ_cuda_probe.py | UNCITED | — | — |
| churn | churn_judge_eval.py | reproduce-pinned | REPRODUCE×2 | — |
| ckpt | ckpt_delete_pass.py | UNCITED | — | — |
| ckpt | ckpt_inventory.py | library | specs×2 | 1 |
| ckpt | ckpt_triage_table.py | UNCITED | — | — |
| clade | clade_stream_d256.py | results-cited | RESULTS×1 | — |
| closers | closers_chain.sh | UNCITED | — | — |
| complex | complex_birth.py | library | — | 8 |
| complex | complex_model.py | library | specs×1 | 7 |
| complex | complex_nnue.py | UNCITED | — | — |
| complexify | complexify_control.py | results-cited | RESULTS×1, specs×1 | — |
...
| detbwd | detbwd_gravmoe.py | library | RESULTS×2, specs×27 | 8 |
...
| distortion | distortion_collapse.py | results-cited | RESULTS×2 | — |
| dual | dual_probe.py | UNCITED | — | — |
| duo | duo_mine.py | UNCITED | — | — |
| duo | duo_wave.py | spec-cited | specs×1 | — |
...
| floor | floor_hk1.sh | library | — | 1 |
| floor | floor_hk1_d256.sh | UNCITED | — | — |
| fmt | fmt_chain.sh | UNCITED | — | — |
| fmt | fmt_chain2.sh | UNCITED | — | — |
| fmt | fmt_pp_watcher.sh | UNCITED | — | — |
| format | format_delta_prep.py | library | — | 2 |
| format | format_ladder.py | library | — | 3 |
| fourier | fourier_g9.py | results-cited | RESULTS×1 | — |
| fourier | fourier_probe.py | UNCITED | — | — |
| fourier2 | fourier2_modbirth.py | UNCITED | — | — |
| fourier2b | fourier2b_widemod.py | library | RESULTS×1 | 2 |
| fourier3 | fourier3_algdiet.py | results-cited | RESULTS×1 | — |
| fourier4a | fourier4a_dynamics.py | results-cited | RESULTS×1 | — |
| fp64 | fp64_paired.py | spec-cited | specs×1 | — |
| fx3 | fx3_house.py | results-cited | RESULTS×1, specs×2 | — |
| g19 | g19_bf16_isolation.sh | spec-cited | specs×2 | — |
...
| gate | gate_ckpt.py | library | RESULTS×3, specs×11 | 38 |
...
| gate | gate_rarity.py | library | RESULTS×1 | 10 |
...
| gt2 | gt2_jaccard.py | library | REPRODUCE×1, RESULTS×3, specs×4 | 12 |
...
| gt5 | gt5_union_keep.py | reproduce-pinned | REPRODUCE×1, RESULTS×1 | — |
...
| holdout | holdout_v2.py | library | — | 2 |
| hot | hot_chain.sh | library | RESULTS×2 | 1 |
...
| k3 | k3_expert_demo.py | library | RESULTS×4, specs×2 | 4 |
...
| metallicity | metallicity_diets.py | library | RESULTS×2 | 1 |
| metallicity1 | metallicity1.sh | results-cited | RESULTS×2 | — |
| moe | moe_gt1.py | library | REPRODUCE×4, RESULTS×4, specs×4 | 5 |
| moe | moe_gt1_arm2.py | library | REPRODUCE×6, RESULTS×6, specs×4 | 5 |
...
| night | night_rat.sh | results-cited | RESULTS×1, specs×1 | — |
| night | night_rat_s2.sh | spec-cited | specs×1 | — |
| night | night_sr.sh | results-cited | RESULTS×1 | — |
...
| night29 | night29.sh | spec-cited | specs×1 | — |
| night29b | night29b.sh | spec-cited | specs×1 | — |
| night30 | night30.sh | spec-cited | specs×1 | — |
| night30 | night30_mac.py | UNCITED | — | — |
| night30b | night30b.sh | UNCITED | — | — |
| night31 | night31.sh | results-cited | RESULTS×1 | — |
...
| oracle | oracle_worker.py | library | REPRODUCE×1, RESULTS×2, specs×1 | 6 |
...
| ozaki | ozaki_cuda2.py | results-cited | RESULTS×1 | — |
| ozaki | ozaki_cuda3.py | results-cited | RESULTS×1 | — |
...
| p3 | p3_ffnslack.py | results-cited | RESULTS×3 | — |
| p3 | p3_grav2.py | results-cited | RESULTS×2 | — |
| p3 | p3_quat.py | results-cited | RESULTS×1 | — |
| p3 | p3_stream2x2.py | results-cited | RESULTS×2 | — |
| p3 | p3_umoe_soft.py | results-cited | RESULTS×1 | — |
| p4 | p4_arms_0801.sh | library | RESULTS×3, specs×11 | 2 |
| pack | pack_baselines.py | spec-cited | specs×1 | — |
| pack | pack_c6.py | library | RESULTS×1, specs×1 | 4 |
| pack | pack_c7.py | results-cited | RESULTS×1 | — |
| pack | pack_crystal.py | results-cited | RESULTS×2, specs×1 | — |
| pack | pack_decode.py | library | RESULTS×4 | 2 |
| pack | pack_determinism.py | results-cited | RESULTS×1, specs×1 | — |
| pack | pack_gemv.py | spec-cited | specs×1 | — |
| pack | pack_p2a.py | UNCITED | — | — |
| pack | pack_rans.py | results-cited | RESULTS×3, specs×2 | — |
| pack | pack_tiered.py | spec-cited | specs×1 | — |
| paper | paper_figs.py | UNCITED | — | — |
| phys | phys_probe.py | UNCITED | — | — |
| pincer | pincer_dist_probe.py | results-cited | RESULTS×1 | — |
| pincer | pincer_dist_report.py | library | — | 1 |
| pincer | pincer_labels_v2.py | library | RESULTS×1 | 1 |
| pincer | pincer_r0.py | results-cited | RESULTS×2 | — |
| pincer | pincer_r0b.py | results-cited | RESULTS×1 | — |
| pincer | pincer_r1_indist.py | results-cited | RESULTS×1 | — |
| pincer | pincer_r1_probe.py | library | RESULTS×1 | 1 |
| pincer | pincer_r1b_labels.py | library | RESULTS×1, specs×1 | 2 |
| pincer | pincer_r8.py | results-cited | RESULTS×1 | — |
| place1 | place1_gravity.py | results-cited | RESULTS×4, specs×1 | — |
| polar | polar_snap.py | results-cited | RESULTS×1 | — |
| poly3 | poly3_pipeline.sh | spec-cited | specs×2 | — |
| poly4 | poly4_pipeline.sh | library | specs×1 | 1 |
| poly4 | poly4_watcher.sh | UNCITED | — | — |
| poly5 | poly5_pipeline.sh | library | specs×1 | 1 |
| poly5 | poly5_watcher.sh | UNCITED | — | — |
| practice | practice_mine.py | spec-cited | specs×1 | — |
| prefix | prefix_pair.sh | UNCITED | — | — |
| probe | probe_int_device_parity.py | results-cited | RESULTS×1 | — |
| prologue | prologue_arms.py | library | — | 1 |
| prologue | prologue_gates.sh | UNCITED | — | — |
| ptq4 | ptq4_arms.py | UNCITED | — | — |
| ptq4 | ptq4_gates.sh | library | — | 1 |
...
| saturation | saturation_s2.py | results-cited | RESULTS×2 | — |
...
| scorer | scorer_s2_train.py | spec-cited | specs×1 | — |
| seeds | seeds_ladder_0804.sh | UNCITED | — | — |
| series | series_probe.py | library | specs×5 | 13 |
| snap | snap_alloc.py | library | specs×2 | 1 |
| snap | snap_anatomy.py | results-cited | RESULTS×1 | — |
| softprompt | softprompt_sampler_probe.py | spec-cited | specs×1 | — |
| softprompt1 | softprompt1.py | library | RESULTS×4, specs×2 | 2 |
...
| sym | sym_convert.py | results-cited | RESULTS×1, specs×2 | — |
| sym | sym_spectrum.py | spec-cited | specs×2 | — |
...
| umoe | umoe_conserve.py | library | RESULTS×2 | 12 |
| v4flash | v4flash_anatomy.py | UNCITED | — | — |
| v4flash | v4flash_census.py | results-cited | RESULTS×1, specs×1 | — |
| v4flash | v4flash_f1b.py | library | RESULTS×1 | 2 |
| v4flash | v4flash_f1c.py | library | RESULTS×1 | 1 |
| v4flash | v4flash_f1d.py | results-cited | RESULTS×4, specs×1 | — |
| v4flash | v4flash_header.py | results-cited | RESULTS×1 | — |
| v4flash | v4flash_router.py | library | RESULTS×1, specs×1 | 3 |
| v4flash | v4flash_rung0.py | results-cited | RESULTS×1, specs×1 | — |
| v4flash | v4flash_rung2b.py | library | RESULTS×1, specs×2 | 1 |
| v4flash | v4flash_rung2b_router.py | results-cited | RESULTS×1 | — |
| v4flash | v4flash_rungA.py | library | RESULTS×2, specs×3 | 8 |
| v4flash | v4flash_rungd.py | library | RESULTS×3 | 1 |
| v4flash | v4flash_rungd2.py | results-cited | RESULTS×1 | — |
| v4flash | v4flash_s0.py | results-cited | RESULTS×3 | — |
| v4flash | v4flash_twin.py | library | RESULTS×4 | 3 |
| verify | verify_intbirth_prims.py | results-cited | RESULTS×1, specs×1 | — |
...
| family | file | class | doc citations | refs |
|---|---|---|---|---|
|  | __init__.py | library | RESULTS×1, specs×4 | 1 |
...
| bench | bench_bestfirst.py | library | — | 1 |
| bench | bench_bestfirst_llm.py | UNCITED | — | — |
| bench | bench_bestfirst_nnue.py | library | — | 1 |
| bench | bench_budget_alloc.py | results-cited | RESULTS×1 | — |
| bench | bench_commute.py | UNCITED | — | — |
| bench | bench_compile.py | library | — | 4 |
| bench | bench_control.py | UNCITED | — | — |
| bench | bench_decoding.py | library | — | 1 |
| bench | bench_derivation.py | spec-cited | specs×14 | — |
| bench | bench_dispatch_race_v4.py | UNCITED | — | — |
| bench | bench_distilled_draft.py | UNCITED | — | — |
| bench | bench_engine_regret.py | results-cited | RESULTS×1 | — |
| bench | bench_entropy_beam.py | library | — | 1 |
| bench | bench_fib_restarts.py | UNCITED | — | — |
| bench | bench_flash_prefill.py | UNCITED | — | — |
| bench | bench_frontier.py | spec-cited | specs×1 | — |
| bench | bench_fused.py | UNCITED | — | — |
| bench | bench_fused_ce.py | library | RESULTS×1 | 1 |
| bench | bench_gated.py | UNCITED | — | — |
| bench | bench_gweight.py | UNCITED | — | — |
| bench | bench_hints_ab.py | results-cited | RESULTS×1 | — |
| bench | bench_hybrid.py | library | — | 1 |
| bench | bench_int4_config_sweep.py | UNCITED | — | — |
| bench | bench_int4_gemv.py | results-cited | RESULTS×1 | — |
| bench | bench_interference.py | UNCITED | — | — |
| bench | bench_ksweep.py | UNCITED | — | — |
| bench | bench_kv_quant_decode.py | library | — | 1 |
| bench | bench_ladder.py | UNCITED | — | — |
| bench | bench_lazy.py | library | RESULTS×1 | 1 |
| bench | bench_llm_gating.py | UNCITED | — | — |
| bench | bench_lookup_static.py | UNCITED | — | — |
| bench | bench_luby.py | UNCITED | — | — |
| bench | bench_magic.py | library | RESULTS×1 | 1 |
| bench | bench_markov.py | UNCITED | — | — |
| bench | bench_markov_adaptive.py | UNCITED | — | — |
| bench | bench_metal_kernels.py | library | specs×8 | 2 |
| bench | bench_mlx_integration.py | UNCITED | — | — |
| bench | bench_nnue.py | library | specs×8 | 1 |
| bench | bench_ode_engine.py | UNCITED | — | — |
| bench | bench_opcap.py | UNCITED | — | — |
| bench | bench_population.py | library | — | 1 |
| bench | bench_pred_syndromes.py | results-cited | RESULTS×1 | — |
| bench | bench_prefix_reuse.py | UNCITED | — | — |
| bench | bench_proposer.py | library | specs×9 | 1 |
| bench | bench_quant_schemes.py | library | RESULTS×1 | 1 |
| bench | bench_record.py | results-cited | RESULTS×1 | — |
| bench | bench_regret_resample.py | UNCITED | — | — |
| bench | bench_rotate_quantize.py | library | specs×2 | 1 |
| bench | bench_rule_basis.py | results-cited | RESULTS×1 | — |
...
| bench | bench_step_tokens.py | library | RESULTS×2, specs×7 | 70 |
...
| bench | bench_verify_fast.py | library | specs×3 | 49 |
...
| figlib | figlib.py | spec-cited | specs×1 | — |
| gen | gen_catalog.py | library | RESULTS×1, specs×1 | 1 |
| gen | gen_codemap.py | library | RESULTS×1, specs×16 | 1 |
...
| gen | gen_index.py | library | specs×6 | 1 |
...
| gen | gen_results_index.py | library | RESULTS×2, specs×12 | 3 |
...
| list | list_uncurated.py | spec-cited | specs×5 | — |
| log | log_hygiene.py | library | RESULTS×1, specs×2 | 1 |
...
| moe | moe_router_stats.py | library | RESULTS×1, specs×2 | 4 |
...
| render | render_hero_neurons.py | library | — | 1 |
| results | results_query.py | library | specs×14 | 1 |
| rjob | rjob.py | results-cited | RESULTS×3, specs×2 | — |
...
| step | step_grpo_micro.py | library | RESULTS×5, specs×7 | 95 |
...
| task | task_arithmetic.py | spec-cited | specs×1 | — |
| task | task_composition.py | UNCITED | — | — |
| tournament | tournament_birth.py | library | — | 9 |
| train | train_calculus.py | library | specs×6 | 5 |
...
| train | train_mathnative.py | library | RESULTS×4, specs×7 | 84 |
