...
Census: UNCITED 221, library 73, reproduce-pinned 10, results-cited 319, spec-cited 89, cited-but-library 61
...
| mathworld0 | mathworld0.py | results-cited | RESULTS | RESULTS×5 | — | 6 |
...
| mathworld1 | mathworld1_actionfinal.py | results-cited | RESULTS | RESULTS×1 | — | 4 |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 8 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×1 | — | 7 |
...
| mathworld1 | mathworld1_axfixture.py | results-cited | RESULTS | RESULTS×1 | — | 3 |
| mathworld1 | mathworld1_birth.py | results-cited | RESULTS | RESULTS×2 | — | 16 |
...
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 11 |
...
| mathworld1 | mathworld1_svpadj.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×3 | — | 1 |
| mathworld1 | mathworld1_svpdesign.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_terminal.py | UNCITED | — | — | — | — |
| mathworld1 | mathworld1_unprod_probe.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_unprodsem.py | results-cited | RESULTS | RESULTS×1 | — | 5 |
