...
Census: UNCITED 227, library 73, reproduce-pinned 10, results-cited 332, spec-cited 89, cited-but-library 61
...
| mathworld0 | mathworld0.py | results-cited | RESULTS | RESULTS×5 | — | 14 |
...
| mathworld1 | mathworld1_actionfinal.py | results-cited | RESULTS | RESULTS×1 | — | 12 |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 16 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 18 |
...
| mathworld1 | mathworld1_birth.py | results-cited | RESULTS | RESULTS×2 | — | 22 |
...
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 13 |
...
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 12 |
| mathworld1 | mathworld1_svpchal.py | UNCITED | — | — | — | 2 |
| mathworld1 | mathworld1_svpchal2.py | UNCITED | — | — | — | 1 |
| mathworld1 | mathworld1_svpchalscore.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 6 |
...
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×2 | — | 8 |
...
| mathworld1 | mathworld1_unprodsem.py | results-cited | RESULTS | RESULTS×1 | — | 13 |
