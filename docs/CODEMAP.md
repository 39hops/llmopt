...
Census: UNCITED 236, library 82, reproduce-pinned 10, results-cited 446, spec-cited 90, cited-but-library 70
...
| atomtraj | atomtraj_pins.py | library | RESULTS | RESULTS×8 | 25 | 3 |
...
| birth19m | birth19m_atoms_traj.py | results-cited | RESULTS | RESULTS×5 | — | 11 |
...
| birth19m | birth19m_curric.py | library | RESULTS, specs | RESULTS×6, specs×1 | 26 | — |
...
| dfa | dfa_act.py | library | RESULTS, specs | RESULTS×3, specs×1 | 3 | 2 |
| dfa | dfa_align.py | library | RESULTS, specs | RESULTS×2, specs×1 | 2 | 3 |
| dfa | dfa_credit.py | library | RESULTS, specs | RESULTS×2, specs×3 | 15 | 1 |
...
| dfa | dfa_probe.py | library | RESULTS, specs | RESULTS×1, specs×1 | 9 | 1 |
...
| sg | sg_credit.py | library | RESULTS, specs | RESULTS×5, specs×3 | 2 | 2 |
| sg | sg_integrity_smoke.py | results-cited | RESULTS, specs | RESULTS×2, specs×1 | — | 1 |
| sg | sg_qualgate.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
| sg | sg_target_audit.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
| sgwriter1 | sgwriter1_qual_driver.sh | results-cited | RESULTS | RESULTS×2 | — | — |
...
| liverun | liverun.py | results-cited | RESULTS | RESULTS×5 | — | 1 |
...
| train | train_mathnative.py | library | RESULTS, specs | RESULTS×5, specs×7 | 97 | 31 |
