...
Census: UNCITED 227, library 73, reproduce-pinned 10, results-cited 341, spec-cited 89, cited-but-library 61
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 21 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 27 |
...
| mathworld1 | mathworld1_birth.py | results-cited | RESULTS | RESULTS×2 | — | 27 |
...
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 16 |
...
| mathworld1 | mathworld1_svpadj.py | results-cited | RESULTS | RESULTS×6 | — | 7 |
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 21 |
| mathworld1 | mathworld1_svpcalscore.py | results-cited | RESULTS | RESULTS×2 | — | — |
| mathworld1 | mathworld1_svpcalscore16.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
...
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 15 |
...
| mathworld1 | mathworld1_svpdiet3.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
...
| mathworld1 | mathworld1_svpgbirth16.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
...
| mathworld1 | mathworld1_svpheldout16.py | results-cited | RESULTS | RESULTS×1 | — | — |
