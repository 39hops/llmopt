...
Census: UNCITED 228, library 73, reproduce-pinned 10, results-cited 360, spec-cited 89, cited-but-library 61
...
| mathworld0 | mathworld0.py | results-cited | RESULTS | RESULTS×6 | — | 16 |
...
| mathworld1 | mathworld1_actionfinal.py | results-cited | RESULTS | RESULTS×1 | — | 15 |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 25 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 45 |
...
| mathworld1 | mathworld1_axfixture.py | results-cited | RESULTS | RESULTS×2 | — | 5 |
...
| mathworld1 | mathworld1_cl1pop.py | results-cited | RESULTS | RESULTS×1 | — | — |
...
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 37 |
...
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 33 |
...
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×5 | — | 10 |
...
| mathworld1 | mathworld1_svpfohrepl.py | results-cited | RESULTS | RESULTS×1 | — | — |
