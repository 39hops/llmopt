...
Census: UNCITED 237, library 82, reproduce-pinned 10, results-cited 448, spec-cited 90, cited-but-library 70
...
| dfa | dfa_credit.py | library | RESULTS, specs | RESULTS×2, specs×3 | 16 | 1 |
...
| dfa | dfa_probe.py | library | RESULTS, specs | RESULTS×1, specs×1 | 10 | 1 |
...
| sg | sg_failure_labels.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
...
| train | train_mathnative.py | library | RESULTS, specs | RESULTS×5, specs×7 | 98 | 31 |
