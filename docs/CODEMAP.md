...
Census: UNCITED 233, library 88, reproduce-pinned 10, results-cited 473, spec-cited 90, cited-but-library 76
...
| atomtraj | atomtraj_pins.py | library | RESULTS | RESULTS×8 | 39 | 3 |
...
| basics | basics_census0.py | results-cited | RESULTS, specs | RESULTS×1, specs×1 | — | — |
| basics | basics_probe0.py | library | RESULTS, specs | RESULTS×5, specs×1 | 2 | — |
| basicsdiet1 | basicsdiet1_driver.sh | results-cited | RESULTS, specs | RESULTS×1, specs×1 | — | — |
...
| birth19m | birth19m_backsched.py | results-cited | RESULTS, specs | RESULTS×3, specs×2 | — | 1 |
| birth19m | birth19m_caf.py | results-cited | RESULTS, specs | RESULTS×2, specs×1 | — | 6 |
| birth19m | birth19m_curric.py | library | RESULTS, specs | RESULTS×6, specs×1 | 33 | — |
...
| birth19m | birth19m_phase.py | results-cited | RESULTS, specs | RESULTS×4, specs×1 | — | 3 |
...
| comp | comp_ladder.py | results-cited | RESULTS, specs | RESULTS×2, specs×1 | — | — |
...
| crossfoster1c | crossfoster1c_launch.sh | results-cited | RESULTS | RESULTS×1 | — | — |
...
| dfa | dfa_probe.py | library | RESULTS, specs | RESULTS×2, specs×1 | 15 | 1 |
...
| ex5 | ex5_traj_census.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
...
| ex6temporal | ex6temporal.py | results-cited | RESULTS | RESULTS×10 | — | 4 |
...
| gate | gate_backsched.py | results-cited | RESULTS, specs | RESULTS×2, specs×2 | — | — |
...
| gate | gate_phase19m.py | library | RESULTS, specs | RESULTS×3, specs×2 | 1 | — |
| gate | gate_pp.py | results-cited | RESULTS, specs | RESULTS×2, specs×1 | — | 1 |
...
| gradmap0 | gradmap0_probe.py | library | RESULTS, specs | RESULTS×1, specs×1 | 1 | — |
| gradmap0 | gradmap0_rd2.py | results-cited | RESULTS, specs | RESULTS×1, specs×2 | — | — |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 27 |
...
| mathworld1 | mathworld1_cl1pop.py | results-cited | RESULTS | RESULTS×1 | — | 3 |
...
| mathworld1 | mathworld1_nestedswap.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_nestedswapverify.py | results-cited | RESULTS | RESULTS×2 | — | — |
...
| mathworld1 | mathworld1_prband2cf.py | results-cited | RESULTS | RESULTS×4 | — | 2 |
...
| mathworld1 | mathworld1_prband_verify.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_regret.py | results-cited | RESULTS | RESULTS×3 | — | 1 |
| mathworld1 | mathworld1_regret_walllift.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_respath.py | results-cited | RESULTS | RESULTS×6 | — | 6 |
| mathworld1 | mathworld1_respath20.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_retrolabel.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_rolecensus.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_rolecensusverify.py | results-cited | RESULTS | RESULTS×2 | — | — |
| mathworld1 | mathworld1_scoreqal.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 19 |
...
| mathworld1 | mathworld1_svpadj.py | results-cited | RESULTS | RESULTS×6 | — | 18 |
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×6 | — | 53 |
| mathworld1 | mathworld1_svpcalscore.py | results-cited | RESULTS | RESULTS×2 | — | — |
| mathworld1 | mathworld1_svpcalscore16.py | results-cited | RESULTS | RESULTS×1 | — | 2 |
| mathworld1 | mathworld1_svpcalscore17.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
| mathworld1 | mathworld1_svpcalscore18.py | results-cited | RESULTS | RESULTS×2 | — | 3 |
| mathworld1 | mathworld1_svpchal.py | results-cited | RESULTS | RESULTS×4 | — | 16 |
| mathworld1 | mathworld1_svpchal2.py | UNCITED | — | — | — | 8 |
| mathworld1 | mathworld1_svpchalscore.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 46 |
| mathworld1 | mathworld1_svpcovdesk.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpdcl.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpdesign.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpdiet.py | results-cited | RESULTS | RESULTS×2 | — | 6 |
| mathworld1 | mathworld1_svpdiet2.py | results-cited | RESULTS | RESULTS×2 | — | 6 |
| mathworld1 | mathworld1_svpdiet3.py | results-cited | RESULTS | RESULTS×3 | — | 9 |
| mathworld1 | mathworld1_svpeval.py | results-cited | RESULTS | RESULTS×7 | — | 16 |
...
| mathworld1 | mathworld1_svpforder.py | results-cited | RESULTS | RESULTS×3 | — | 18 |
...
| mathworld1 | mathworld1_svpgbirth17.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
| mathworld1 | mathworld1_svpgbirth18.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
| mathworld1 | mathworld1_svpgenadj.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpgeodesk.py | UNCITED | — | — | — | — |
...
| mathworld1 | mathworld1_svpheldout16.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_svpheldout17.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
| mathworld1 | mathworld1_svpheldout18.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
| mathworld1 | mathworld1_svpldesk.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpnuisdesk.py | results-cited | RESULTS | RESULTS×2 | — | 4 |
| mathworld1 | mathworld1_svpp2qual.py | results-cited | RESULTS | RESULTS×1 | — | 5 |
| mathworld1 | mathworld1_svppoutscore16.py | results-cited | RESULTS | RESULTS×1 | — | — |
...
| mathworld1 | mathworld1_svptokonset.py | results-cited | RESULTS | RESULTS×1 | — | 2 |
...
| ogd0 | ogd0_launch.sh | results-cited | RESULTS | RESULTS×1 | — | — |
| oma1 | oma1_launch.sh | results-cited | RESULTS, specs | RESULTS×1, specs×1 | — | — |
| onecycle | onecycle_component_audit.py | library | RESULTS | RESULTS×1 | 1 | — |
| optimizer | optimizer_geometry_desk.py | library | RESULTS, specs | RESULTS×3, specs×1 | 1 | 2 |
| optimizer | optimizer_memory_ablation.py | results-cited | RESULTS | RESULTS×4 | — | 1 |
...
| qwen | qwen_alttok_derive.py | UNCITED | — | — | — | 1 |
...
| qwen | qwen_effort_probe.py | results-cited | RESULTS | RESULTS×1 | — | 9 |
...
| qwen | qwen_loop_state_adjudicate.py | results-cited | RESULTS | RESULTS×1 | — | — |
| qwen | qwen_loop_state_color2.py | results-cited | RESULTS | RESULTS×1 | — | — |
| qwen | qwen_loop_state_headswap.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
...
| qwen | qwen_residual_census.py | results-cited | RESULTS | RESULTS×3 | — | 1 |
| qwen | qwen_residual_loo.py | results-cited | RESULTS | RESULTS×1 | — | — |
| qwen | qwen_rk_adjudicate.py | results-cited | RESULTS | RESULTS×1 | — | — |
| qwen | qwen_rk_census.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| qwen | qwen_rk_rider.py | results-cited | RESULTS | RESULTS×1 | — | — |
...
| qwen | qwen_topset_census.py | UNCITED | — | — | — | — |
...
| routedb | routedb_replay.py | results-cited | RESULTS | RESULTS×2 | — | 4 |
| routedb | routedb_replay2.py | results-cited | RESULTS | RESULTS×4 | — | 1 |
| routedb | routedb_time.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
| routedb | routedb_time0r.py | results-cited | RESULTS | RESULTS×2 | — | — |
...
| tenet | tenet_d2_revdiet.py | library | RESULTS, specs | RESULTS×1, specs×1 | 35 | — |
...
| update | update_geometry_census.py | library | RESULTS, specs | RESULTS×4, specs×2 | 2 | 2 |
...
| book | book.py | library | RESULTS, specs | RESULTS×4, specs×5 | 1 | 2 |
...
| farm | farm_algebra.py | results-cited | RESULTS | RESULTS×2 | — | 1 |
...
| liverun | liverun.py | results-cited | RESULTS, specs | RESULTS×10, specs×2 | — | 10 |
...
| step | step_grpo_micro.py | library | RESULTS, specs | RESULTS×6, specs×19 | 95 | 5 |
...
| train | train_mathnative.py | library | RESULTS, specs | RESULTS×7, specs×7 | 111 | 33 |
