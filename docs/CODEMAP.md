...
Census: UNCITED 227, library 73, reproduce-pinned 10, results-cited 337, spec-cited 89, cited-but-library 61
...
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×2 | — | 23 |
...
| mathworld1 | mathworld1_svpbirth.py | results-cited | RESULTS | RESULTS×5 | — | 17 |
| mathworld1 | mathworld1_svpcalscore.py | results-cited | RESULTS | RESULTS×2 | — | — |
| mathworld1 | mathworld1_svpchal.py | UNCITED | — | — | — | 5 |
| mathworld1 | mathworld1_svpchal2.py | UNCITED | — | — | — | 4 |
| mathworld1 | mathworld1_svpchalscore.py | results-cited | RESULTS | RESULTS×1 | — | — |
| mathworld1 | mathworld1_svpcode.py | results-cited | RESULTS | RESULTS×1 | — | 11 |
...
| mathworld1 | mathworld1_svpdiet.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
| mathworld1 | mathworld1_svpdiet2.py | results-cited | RESULTS | RESULTS×2 | — | 2 |
...
| mathworld1 | mathworld1_svpnuisdesk.py | results-cited | RESULTS | RESULTS×2 | — | — |
