...
Census: UNCITED 221, library 73, reproduce-pinned 10, results-cited 316, spec-cited 89, cited-but-library 61
...
| mathworld1 | mathworld1_actionfinal.py | results-cited | RESULTS | RESULTS×1 | — | 3 |
...
| mathworld1 | mathworld1_actionsem.py | results-cited | RESULTS | RESULTS×2 | — | 7 |
| mathworld1 | mathworld1_actionsite.py | results-cited | RESULTS | RESULTS×1 | — | 1 |
| mathworld1 | mathworld1_actiontok.py | results-cited | RESULTS | RESULTS×1 | — | 4 |
...
| mathworld1 | mathworld1_axfixture.py | results-cited | RESULTS | RESULTS×1 | — | 2 |
| mathworld1 | mathworld1_birth.py | results-cited | RESULTS | RESULTS×2 | — | 13 |
...
| mathworld1 | mathworld1_srepr_export.py | results-cited | RESULTS | RESULTS×3 | — | 10 |
...
| mathworld1 | mathworld1_unprodsem.py | results-cited | RESULTS | RESULTS×1 | — | 4 |
