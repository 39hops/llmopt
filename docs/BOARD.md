...
| **ZX CONTINENT (seed-2 BOOKED 28/120 — noise floor flagged; control in flight)** | union verdict IN: math 66/120 ties best, ZX 40/120 (now reads at-class, not above: seed-2 landed 28/120, 8-pt swing, sigma-class ~5.7 → +-5 fence on every single-seed ZX gate); JOB 3 RUNNING: fp32-real ZX-only control (bands overlap under sigma — books WITH the fence; marker: night_zx2_launcher_done). Friendly-fire #7 (shared wsl job file) fixed dd6f7f3 | RESULTS 2026-07-27 seed-2 verdict |
