...
| **NATIVE TRANSFORMER (specced, 3 rungs)** | rung 1 prefix notation (Mac, behind width ladder — serializer is Fable work first); rung 2 subtree-hash tree-PE (zero-epoch north star); rung 3 attention-init (ep1-speed graded); forbidden forms listed in spec | specs/2026-07-25-native-transformer.md |
