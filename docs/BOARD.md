...
| **ZX CONTINENT (n=3 fence; 45M UNION IN FLIGHT tonight)** | 19M verdicts rest (arm 36/28/34, union +1.8sig suggestive, control non-discriminating); 45M union birth RUNNING on 3080 (pre-reg'd: math 66-69 = union free at scale; ZX 37+ = first number clear of the fence; marker night_45m_done) | RESULTS 2026-07-27 45M pre-reg |
