...
| **EXACT REPRESENTATIONS (Artin's push, LIVE — the day's new program)** | Booked tonight: rational twin Q=64 at parity (~10.5 bits/wt minimal at Q=48); knee = CLIFF [1.7e-3, 3.7e-3]; SNAP ANATOMY: wall is HORIZON x near-tie density, NOT weights (2 flips/2512, margins 1.6e-4 v median 8.9); dither null. IN FLIGHT: born-rational RAT_Q=6 paired arms (Mac, control 60 booked); quick exact battery on union_45m (3080: rational transport / integer twin fq512-fq128 / thin-film repair). QUEUED: GPTQ-rational (compute-the-number), mixed-Q water-filling, RNS optimizer step | specs/2026-07-27-exact-representations.md |
