...
Updated 2026-07-27 morning (newest handoff: -27-1 the-verdict-morning; live specs: 2026-07-27-calibrated-scorer + 2026-07-27-exact-stack; query verdicts: scripts/results_query.py --live). RESULTS.md holds verdicts, RIFF-LEDGER.md
...
| **ZX CONTINENT (n=3 sigma BOOKED; night chain complete)** | arm 36/28/34 (sd ~4.2) = the standing seed fence; union ZX 40 = +1.8 sigma (suggestive, not clean); ZX-only control 35 non-discriminating; union-tax-free holds. Next: more union seeds OR bigger effect, else column rests | RESULTS 2026-07-27 seed-3 verdict |
...
| **EXACT STACK (bridge LIVE on Mac; E4 FAILED)** | axiom pushed (23 commits, 405a6d4..6338b7c) after house found the sync gap; Mac .so built+deployed, IV==3 PASS; E4 parity FAILS every prong (agree 161/184, 21 ax-misses, 2 ax-claims, plies +1/+2, Subs parsefail) -> engine=axiom namespace PERMANENT pending audit; asks out: expired flag (censored!=fact), basis-rule audit, ply semantics. NEXT: E2 exporter (model.hpp read), E5 batch-1 regen, E1 needs axiom's container BYTES | RESULTS 2026-07-27 E4 verdict |
