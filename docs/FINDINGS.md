...
- [SINGLE-SEED] [REGIME-SCOPED: house crystals] OneCycle DIRECTION
  is a non-factor at 19M/gen4 (scheduler-law correction, AMENDMENT
  WRITER-INTERVENTION-SCHEDULER-LAW RESULTS.md#L73710: the backward
  birth's SequenceLR also held beta1 at 0.9 where stock OneCycle cycles
  it 0.95 -> 0.85 -> 0.95, so the contrast is LR direction plus beta1
  law): a birth with the lr sequence played
...
- [SINGLE-SEED] SVP secondary P-OUT test REVERSED its prior: on 48 fresh degree-11 covered-I0/t2 states (novel P-form/degree-class), HASH beats FACTOR 33/48 v 15/48 (0 F-only v 18 H-only discordants, McNemar p=7.6e-06) — booked SECONDARY-INCONCLUSIVE under the frozen FACTOR-directional law with the reverse split disclosed; FACTOR's 15 solves come entirely from the two boundary forms (x^11+x, x^11+x^10), 0/32 on interior forms, suggesting factored codes bind to trained coordinate patterns while arbitrary-identity codes degrade uniformly (hypothesis, unregistered); seed-15001 degree-10 desk residue did not transport; same seed-16001 checkpoints as the STRONG-FACTOR heldout result (correlated, different population/question — the strict verdict is untouched). RESULTS.md#L54553
- [SINGLE-SEED] SVP BIRTH-17001 sealed: the init-only replication birth (seed 17001, sole changed variable — 56-line driver diff independently classified zero-substantive, init pin 4384ed98 rebuilt byte-for-byte) hit every exact invariant of the frozen protocol (7,020 updates + 2,021,220 continuation tokens/arm, identical padded/non-pad totals, 3,510/3,510 order, zero held-out labels, wall 3,478.5 s in band); FACTOR 12e19fae / HASH e24237b8 sealed UNSCORED — replication status entirely undetermined until the frozen four-outcome law adjudicates at CALIBRATION/HELDOUT-SCORE-17001. RESULTS.md#L54721
- [SINGLE-SEED] SVP seed-17001 calibration FIRED: the fresh-init arms clear the frozen frequency-stratified gate near ceiling (FACTOR 93/96 = c-IN 46/48 + c-OUT 47/48, three hair-margin rank-2 misses; HASH 96/96; every cell 22-24/24 v the 12/24 floor) — covered competence on trained P forms has now held at two independent inits (16001: F 94/96, H 96/96; per-seed report, never pooled); REPLICATION-NOT-REACHED is off the table and HELDOUT-SCORE-17001 is eligible under the frozen four-outcome law; competence gate only, no F-v-H reading. RESULTS.md#L54872
- [REPLICATED] SVP strict-grid STRONG-FACTOR replicates at a fresh initialization: seed 17001 (init the only changed variable) returns REPLICATES-STRONG-FACTOR under the frozen four-outcome law — F 75/96 v H 63/96 (20/8 discordants, McNemar p=.0357; matched sign 21+/6-, p=.0059; direction survives baseline-miss removal), beside seed 16001's 84/96 v 41/96 (44/1, p=2.6e-12) — two realizations, one fixed dataset/HASH-permutation/population/protocol, per-seed table only, never pooled; effect size is strongly realization-dependent (43 v 12 solve split, the 17001 McNemar one-state sensitive at its alpha bar) and cell-level anatomy does NOT replicate (t3-collapse at 16001 v t3-edge at 17001, descriptive); establishes no seed-population or HASH-permutation generality, and the degree-11 P-OUT reverse split stands booked beside it. RESULTS.md#L55052
- [SINGLE-SEED] SVP HASH-P2 materialized + qualified under the anti-selection law: the first and final realization of the salt-changed Feistel (salt bound to prereg commit 7976613b, first two sha256 bytes big-endian mod 4096) passed every exhaustive bar (884,736/884,736 injectivity + exact roundtrip; P1/FACTOR unchanged; all 74,860 training actions + 963 eval candidate actions covered) and is UNREMARKABLE in every registered census (0 whole-code agreement with P1/FACTOR, prefix agreement within 1.6 sigma of chance at all lengths, P1-like exposure balance) — realization pin 952f332d, independently rebuilt byte-for-byte by a second implementation; zero model/performance evidence exists for P2 (that is the point: selection closed before realization). RESULTS.md#L55538
- [SINGLE-SEED] SVP THREE-ARM BIRTH-18001 sealed: one shared seed-18001 init trained FACTOR / HASH-P1 / HASH-P2 at exactly equal compute (7,020 updates + 2,021,220 continuation tokens per arm, identical padded/non-pad totals across all three, lexicographic six-cycle order census 6x1,170 with every arm 2,340 per execution slot, 21,060 finite losses; P2 realization re-derived pre and post training == its qualification pin 952f332d) — checkpoints ecf5be31 / 1ec2ea43 / 26e4afc3 sealed UNSCORED; no H1-v-H2 or F-v-H comparison of any kind exists yet; permutation-replication status entirely undetermined until the frozen three-arm calibration gate and known-set IUT law adjudicate. RESULTS.md#L55712
- [SINGLE-SEED] SVP three-arm seed-18001 calibration FIRED: FACTOR 96/96, HASH-P1 96/96, HASH-P2 92/96 (min cell 21/24 v the 12/24 floor; H2's four misses all in frequency-extrapolated c-OUT, inside single-seed noise, descriptive only) — the first model ever trained on the P2 code clears the frozen competence gate; covered competence now 7/7 arm-realizations across three seeds and two HASH bijections; KNOWN-SET permutation heldout eligible under the frozen IUT law; gate only, no representation reading. RESULTS.md#L55874
- [SINGLE-SEED] SVP known-set permutation test booked KNOWN-SET-P2-ONLY-STRONG-FACTOR, refuting the naive treatment story: at seed 18001 FACTOR beat the fresh bijection HASH-P2 massively (85/96 v 43/96, McNemar p=4.5e-10, sign 43+/4- p=2.8e-09) but HASH-P1 ALSO completed the withheld combinations (83/96 v 85/96, 2/0 discordants, p=.5 — null, not equivalence); same-init H1-v-H2 sensitivity 46/6 discordants p=1.0e-08 while their covered totals differ by only 4. Per-realization record on one frozen population: FACTOR 84/75/85 stable; HASH-P1 41/63/83 across seeds; HASH-P2 43 — the F-v-H contrast is dominated by CONTROL-ARM variance across seed x bijection realizations, not factorization stability alone; "arbitrary identity cannot complete withheld combinations" is now measured FALSE for at least one realization; which bijection property predicts completion is open and unregistered. Known-set treatment replication only; never pooled; the P-OUT reverse split stands beside it. RESULTS.md#L56104
- [SINGLE-SEED] SVP field-order stage 1 sealed: the causal serialization intervention materialized cleanly — PARAM-FIRST is the literal PERM of the canonical factor payload (884,736/884,736 roundtrips + perm + token-multiset identity in both arms; aggregate exposure exactly equal), and the pre-training structural census matched the prospectively frozen 8->3 prediction from bytes before any model existed (the same 67 late states relocate k=8 -> k=3; the same 29 stay at k=1, group identities gated); the paired seed-19001 birth hit every exact invariant (7,020 updates + 2,021,220 tokens/arm, identical totals, 3,510/3,510); CANONICAL ae0a86e0 / PARAM-FIRST 0fe38f78 sealed UNSCORED — no evidence yet on completion damage/reversal or onset relocation. RESULTS.md#L57071
- [SINGLE-SEED] SVP field-order calibration FIRED: both serializations of the same semantic coordinates learn the covered support near ceiling (CANONICAL 94/96, PARAM-FIRST 93/96; every cell 21-24/24 v the 12/24 floor) — moving the parameter block to the front does not harm covered-support learnability; 9/9 passing arm-realizations of the revised protocol across four seeds, two code laws, two field orders; stage 3 (known-set heldout completion + fresh-run onset relocation) now eligible under the frozen law; competence gate only, no field-order-superiority reading. RESULTS.md#L57246
- [SINGLE-SEED] SVP field-order intervention booked cell B — ORDER-LOAD-BEARING + SOCKET-MOVES: the learned decision step FOLLOWS the relocated semantic coordinate (fresh k_step CANONICAL 8, PARAM-FIRST 3, both matching the structural predictions frozen before training) AND moving it earlier significantly harms completion (85/96 v 78/96, discordants 8/1, exact McNemar p=.0390625) — identity and ordering interact, per the frozen map; PARAM-FIRST's relocated socket fires at k=3 (48/67 of the relocated group immediately) but finishes 49/67 v canonical's 56/67, and it transiently drops 29->11 on the early group while consuming the fronted param block; BOTH endpoints are one-state boundary-adjacent (7/1 discordants would give p=.070; the PF argmax margin is gain 30 v 29), single realization seed 19001, known-set only. RESULTS.md#L57428
- [SINGLE-SEED] FIELD-ORDER replication stage 1 (seed 20001): world + structural 8->3 intervention reproduced exactly from bytes pre-init (per-state maps identical to 19001 census, 96+96; 884,736 roundtrips; 74,860 rows re-gated), init seed sole changed variable (fresh-context semantic diff clean), two-arm birth sealed UNSCORED (7,020 updates/arm, 3,510/3,510 order, all gates green); no calibration/onset/completion evidence exists yet. Scope: Mac/mps, init-only replication, known-set world. RESULTS.md#L57681
- [SINGLE-SEED] FIELD-ORDER replication stage 2 (seed 20001): calibration FIRED — CANONICAL 85/96 (c-IN 42/48, c-OUT 43/48, min cell 18/24), PARAM-FIRST 91/96 (c-IN 47/48, c-OUT 44/48, min cell 20/24), all frozen bars passed both arms; competence gate only, no arm comparison adjudicated, no heldout/onset value computed; joint heldout + onset stage eligible. Scope: Mac/mps, covered support only. RESULTS.md#L57773
- [SINGLE-SEED] FIELD-ORDER replication stage 3 (seed 20001): FAILS-MECHANISM-REPLICATION with significant ORDER-REVERSAL named beside it — PARAM-FIRST k_step=5 not the structural 3 (gain(3) NEGATIVE -12; CANONICAL k_step=8 aligned, margin 17), and completion favors the REORDERED arm (PF 87/96 v C 80/96, discordants 0/7, p=.015625). Across the two realizations (19001 ORDER-DAMAGE p=.039 / 20001 ORDER-REVERSAL p=.016, never pooled) both the decision-step position and the completion direction are initialization-dependent under one frozen world; the 19001 cell-B claim holds only at its registered single-realization scope. Scope: Mac/mps, known-set, two seeds, one world/population/intervention. RESULTS.md#L57839
- [SINGLE-SEED] Field-block credit desk over both FIELD-ORDER realizations (posthoc, descriptive, raw-artifact-only): CANONICAL routes discrimination through the final PARAM block in both seeds (+56/+46 of 96); PARAM-FIRST routes through PARAM at 19001 (+59 at k=3) but through RULE at 20001 (PARAM +17, RULE +70; 70/96 states rescued after trailing at end-of-PARAM, where PARAM still adds positive fixed-rival credit) — initialization-dependent autoregressive credit routing, n=2 seeds, association never causality; SITE top-1-inert all four cells; rescue anatomy names a concrete mechanism by which ranking may overestimate free generation. RESULTS.md#L57971
- [MECHANISM-CONFIRMED] [REGIME-SCOPED: specified diet and recipe] Ranking-to-generation transport FAILS at the maximum possible separation on all four field-order checkpoints: strict-heldout greedy free generation = 0/96 teacher-match everywhere (ranking 85/78/80/87, discordants 85/0-87/0, all p<1e-23) with PERFECT syntax/decode (96/96) and healthy covered generation (67-85/96, though below every ranking reference — the registered calibration fork engages, so the heldout collapse is not attributed purely to strict recombination); the failure is a pure single-field param_index substitution at the withheld coordinate's low digit (first error position 8 canonical / 3 param-first, 96/96 all cells; the model emits the values that co-occurred with that site in training); the desk's rescue validity threat confirmed 70/70 in the central cell. Strict-heldout ranking wins measure the ability to RANK the withheld combination, not to PRODUCE it — one-step greedy scope, four checkpoints, two known populations, no closed-loop claim. RESULTS.md#L58370
- [MECHANISM-CONFIRMED] [REGIME-SCOPED: specified diet and recipe] The 0/96 free-generation collapse is a pure INTERNALIZED-LEGALITY gap, cell A all four checkpoints: legal-trie greedy (hard support only, no teacher signal) lifts strict-heldout generation from 0/96 to 75-87/96 (all p<1e-22) and equals full-sequence ranking state-for-state in 3 of 4 cells (fourth: L 75 v R 80, p=.0625, unresolved; L a strict subset of R everywhere — local legal greedy never beats global scoring); recovery is NOT oracle-forced — zero forced-teacher, every non-early success is the model locally choosing the withheld coordinate among 2-3 legal options while ~99.9% of its unconstrained mass sits on the illegal trained-co-occurrence substitution (teacher token full-vocab rank 3-6, gap ~7-9 nats); calibration ladder repairs identically (67-85 -> 85-94 = R). Scope: four checkpoints, two known populations, one-step; trie is an oracle intervention, never autonomous competence; no closed-loop claim. RESULTS.md#L58795
- [SINGLE-SEED] CLOSED-LOOP-1 assessment: GO — hybrid controller (engine legality + learned preference) is well-posed, leakage-clean (legal sets from successors + program derivation carry no teacher/future signal), and cheap (~4.8 h worst-case, 96 fresh fork-materialized roots); legal-trie greedy dies as an arm (no computational advantage, strict subset of ranking) — nominated arms ENGINE-HCE v MODEL-LEGAL-RANKING v RANDOM-LEGAL, episode-level paired solved endpoint, one inferential contrast; named transport risk: one-step competence was measured on 2-5 designed distractors, natural legal sets run 3-10 median ~7-8 plus generator shift; engine-hce baseline sits at 92% solved (ceiling/power fence); training labels are NOT hce choices (reverse-relabeled lineage), so B-v-A is a genuine policy comparison. Nothing implemented. RESULTS.md#L58969
- [SINGLE-SEED] CLOSED-LOOP-1 population materialized + qualified: 96 roots (24/level L4-L7) frozen at manifest 50c05794, outcome-blind deterministic scan (108 attempts, 12 prior-exposure skips, zero failures/dup/depth-0; the 30 s scan timeout never fired — no construction selection effect) against a 60,697-state exclusion universe; per-category overlap 0/96 in all four frozen categories PLUS 0-hit witnesses against the checkpoint's other two pinned training artifacts; 21/96 roots appear verbatim in non-pinned earlier-lineage data corpora (disclosed — fresh means the frozen categories, nothing broader); sealed and unscored, no checkpoint loaded, no episode run. RESULTS.md#L59428
- [SINGLE-SEED] CLOSED-LOOP-1 fired MODEL-WORSE: the hybrid controller (engine legality + frozen seed-19001 CANONICAL ranking) solves 85/96 v ENGINE-HCE 92/96 (discordants 7/0, exact min-lik McNemar p=.015625; RANDOM-LEGAL 30/96 descriptive — learned preference does large work above bare legality), encoding-confound gate PERMITS preference/transport attribution (2/7 encoder-class) — but the loop was SHALLOW (81/92 A and 78/85 B solves take one decision; i_heurisch legal at depth 0 on 50/96 roots; A/B byte-identical trajectories on 78/96), the firing clears the frozen region by exactly two discordants (dropping the 2 encoder-failure roots gives 5/0 p=.0625), and 4/7 losses are depth-0 expand-choice engine-wall blowups (legal sets 6-8 -> 27-76) whose fate at a larger cap is unmeasured; deep closed-loop transport stays open. Scope: Mac/mps, one checkpoint/seed, one 96-root population, frozen budget. RESULTS.md#L59529
- [SINGLE-SEED] Policy-splice assessment: the 2x2 depth-0 splice desk (AA/BB in-process anchors, BA/AB counterfactuals) is operationally well-defined on the 16 roots with genuine depth-0 A/B choice divergence (6 discordant + 7 concordant-solved controls + 3 concordant-failed; root 93 excluded — B never chose), budget preserved (12 decisions total incl. forced action, 60 s engine wall from root, model wall excluded as registered); AA/BB cannot serve as frozen references (one measured cross-process legal-set nondeterminism instance) so all four cells run in one process with anchor-outcome AND anchor-action nonreproduction as disclosed classes; existing receipts already show the expand externality signature on 6/7 expand roots (depth-1 legal sets 22-76 from 6-8, sstr 1.87-5.7x; root 23 named counter-instance) — enough to nominate branching-factor/expression-length as the cost-proxy family without tuning; encoder det_ambiguous thread stays separate; any splice result is posthoc localization that cannot touch the MODEL-WORSE p=.015625. Nothing executed. RESULTS.md#L59667
- [SINGLE-SEED] Policy-splice desk localizes the CLOSED-LOOP-1 regret to the FIRST ACTION: with 32/32 in-process anchors reproducing the booked depth-0 actions and outcomes exactly, 5 of the 6 causal-eligible discordant roots book FIRST-ACTION-SUFFICIENT (23, 54, 68, 88, 94) and none book TAIL-POLICY-SUFFICIENT — forcing the model's single depth-0 choice defeats the full ENGINE-HCE tail on all four expand focus roots (BA wall-caps 61.9-71.3 s; depth-1 legal sets 37-76 v 7), while handing the model A's first action rescues 5/6 (AB solves in 2) and even wins root 72 where BOTH anchors failed; depth-0 anatomy: hce ranks A's action 1st on all six expand-family roots while the model ranks its own expand/i_sum 1st (A's action 2nd-4th, branching 4.6-12.7x, length 3.9-5.7x) — a preference inversion whose cost lands on the engine; root 78 OVERDETERMINED is encoder-mediated (gloss does not transfer) and the seven ROBUST controls never invoked the model tail. Scope: posthoc desk, 16 known roots, n=6 causal subset, UNRESOLVED tendency, one checkpoint/population/budget; MODEL-WORSE p=.015625 untouched; frontier = depth-0 search-cost preference, cost proxies (branching factor, expression length) nominated unfit. RESULTS.md#L60177
- [SINGLE-SEED] Search-cost-proxy assessment: the first cost instrument should target SEARCH-EXPANSION REGRET only (root 23, the cycle-loss counter-instance, breaks any single search-cost concept and gets a magnitude-criterion negative control, not a blanket rule); deployable family = string-level child measures (log expression-length ratio, log additive-term ratio, Integral-node count — P2/P3 new nominations) computable today from sealed strings for all 687 depth-0 candidates of the 96 development roots (95/96 with full model scores; positional join law mandated, 69/96 roots have duplicate action names); EXACT child branching is DIAGNOSTIC-ONLY — one post-expand stability-law enumeration measures 5.9-21.9 s in the sealed splice raw, so K-candidate online lookahead burns the 60 s budget precisely on the dangerous states; per-candidate hce exists NOWHERE (splice riders carry 16 chosen actions only) and the development desk prices at ~1-3 h queued; lambda is unavoidable (measured top1-top2 S0 gaps median 5.4 nats v log length-ratios ~1.4-1.8, implied lambda ~3-4), development-selected under a frozen rule-shape and transported frozen with the family choice to a fresh sealed population; proxy compute counts against the same 60 s engine wall. Assessment only, nothing computed against outcomes. RESULTS.md#L60346
- [SINGLE-SEED] Search-cost-proxy desk books NO-CLEAN-CHEAP-PROXY, and the failure is the NEGATIVE CONTROL, not focus power: at lambda 4 all three frozen string proxies surgically demote all four expand landmines (first-demote lambda 4 everywhere, collateral 4-5/91, replacement = the i_transcend_div child, zero equal/higher-cost displacements), but root 23's own baseline choice is expand on a 0.086-nat margin, so every expansion penalty flips it at lambda 0.25-0.5 and the frozen conjunction is unsatisfiable — with the descriptive twist that the "failing" flips on roots 23 and 94 land on their engine-solving actions; proxies are valid expansion surrogates (P4 Spearman .70-.87 over 687/687 swept children — P4 itself process-relative, 2/6 replays differ; C2==C3 on 421/687 so ~2.4 independent directions) at microsecond cost (mean 8.7 us/candidate, ~5-6 orders under engine work); confirmation gate BLOCKED mechanically; the conjunction failure hinges on one low-margin root (n=1, no shape claim). Scope: development desk on the known 96-root population, one checkpoint, no rollout, no solve-rate reading; revised control laws are new design needing their own prereg. RESULTS.md#L60820
- [SINGLE-SEED] Residual-path census assessment: the exhaustive 2^8=256 whole-block passthrough cube is exactly implementable on the 8-block pre-norm MicroLM as a runtime loop-skip (verified: blocks in a ModuleList loop, per-block RoPE re-derives positions from 0, final norm/head outside; no weight edit, no cache hazard on the one-forward teacher-forced ranking law); cleanest first census = seed-19001 CANONICAL+PARAM-FIRST same-init pair on the two sealed 96-state populations (booked baselines 85/78 heldout, 94/93 calibration), full cube ~18 min forward compute (svpfoheld20 books 2.1 s per 192 state-batches — an earlier 30.6 s draft figure was svpdcl's wall, caught in audit); near-full tolerance frozen pre-curve at within-2-states with the full k-v-tolerance curve reported; baseline gate shaped as a tolerance coherence check against frozen raws (never a cross-run bit-exact mps precondition); same-init FACTOR/HASH pairs exist at 3+ seeds (single init_pin per receipt) for a second contrast; claim ceiling frozen: inference-time dispensability never implies training necessity. Assessment only, nothing run. RESULTS.md#L60991
- [SINGLE-SEED] Exhaustive 256-mask residual-path census: EFFECTIVE DEPTH IS TASK-DEPENDENT, NOT REPRESENTATION-DEPENDENT, and field order ROUTES computation to different blocks — with perfect baseline coherence (0/96 mismatch all four cells, exact booked totals 85/78/93/94, heldout per-token drift exactly 0.0), strict-heldout ranking is computable at k=1-2 blocks while covered calibration needs k=4-5 (near-full fractions 19-25% v 3.1-3.5%); the C-v-PF depth quantities differ by at most one block and book UNRESOLVED (the multi-signal conjunction fails: min-k direction flips between populations, near-full fractions run opposite), but per-block necessity separates sharply in the frozen paired form — PARAM-FIRST concentrates in BLOCK 1 (deletion -32 calibration / -8 heldout; 31/20 paired-discordant states; singleton 86-87) while CANONICAL runs through BLOCK 3 (deletion -25; 25 discordant; broader singleton profile) — reading E, the depth-axis companion to the booked k_step relocation; the full model is not the envelope maximum in 3/4 cells (best masks 92/86/96-PERFECT/93; heldout PF's k=1 partly weak-baseline artifact since 42 masks beat its full 78). Scope: inference-time facts on two frozen seed-19001 functions, one realization, no training-necessity claim, seed-20001 replication imported as the gate before any architectural claim. RESULTS.md#L61504
- [SINGLE-SEED] Routing-replication assessment: the seed-20001 256-mask cube is runnable with zero regeneration (checkpoints 0a841a5f/b7198ff2, shared init 7c95e77f, frozen scoring raws for both populations 18f27b66/5df6ee83; booked ranking baselines heldout C 80 / PF 87, calibration C 85 / PF 91 — baseline geometry inverts v 19001 on BOTH populations, making the ceiling fence doubly mandatory); full cube recommended over a targeted panel (confirmation-bias hazard, ~10.5 min measured precedent); routing endpoint frozen block-label-agnostic with a four-cell candidate truth table (REPLICATES / NOT-RESOLVED / RECONFIGURES sub-label / SHARED-CONVERGED) and integer floors owed to the prereg; registered mechanism prior = RECONFIGURATION (warranted by an explicitly labeled analogy to the initialization-dependent credit routing, not a layer mapping); task-depth replication law 2/2-arms strict ordering; two-initialization claim ceiling. Assessment only, nothing loaded. RESULTS.md#L61701
- [SINGLE-SEED] Seed-20001 residual-path replication books ROUTING-NOT-RESOLVED at the classifying population — the 19001 representation-routing finding is initialization-specific: 20001 CANONICAL has NO load-bearing calibration block (max deletion cost 6 < the frozen 8 floor; deleting blocks 7/2 GAINS 11/9) while PARAM-FIRST concentrates in BLOCK 0 (deletion -48/-24, 39-state discordance; its dominant block moved {1}->{0}); TASK-DEPTH-PARTIAL 1/2; heldout descriptively REPLICATES routing ({4} v {0}, 15/16 discordant) but at correlated-effective-n ~1-2 (96 states collapse to ~16 signature classes; one 10x-replicated decision type meets the floor alone) and the separating population EXCHANGES roles across seeds. Sharpest cross-seed fact: mask-0 logits are mathematically context-free, exhaustive enumeration over the 7 candidate codes gives an 87/96 problem-blind ceiling in both populations, the 20001 mask-0 sits EXACTLY at it in all four cells (19001: 0/96) and three of four 20001 full models sit at or below it — only calibration PF (91) beats a problem-blind prior, so the min-full-k=0 cells are degenerate and C-v-PF depth books UNRESOLVED (fence ambiguity resolved conservatively). Coherence perfect (0/96 all cells, drift 0.0/<=4.6e-06); receipt prereg-string inherited-literal defect disclosed (prereg_commit correct throughout). Scope: two seeds, no pooling, no mechanism claim; where competence settles (blocks v embedding/head) is itself initialization-dependent, carried as anatomy. RESULTS.md#L62175
- [SINGLE-SEED] Zero-depth-prior assessment explains the 87/96 problem-blind ceiling from evaluation geometry: both sealed 96-state populations are the same seven-code ranking problem (i_unprod term_index 1-5 at one site, i_sum in all 96 states, euler in 44); gold is always term 2 (48) or term 3 (48); the two golds co-occur in 37 states (28 v 9) — the only contradictory precedence pair — so all 144 optimal fixed orderings miss the same 9 gold=term-3 states and 87 = 96-9 is a structural constant (macro-by-signature ceiling 14/16 = 0.875, the misses being two whole cells); mask-0 is an exact first-order Markov action prior (score spread 0.0 C / <=1.4e-06 PF across code recurrences, all 8 cells); the 20001 prior sits at that ceiling and does NOT track first-order training marginals (7-code null) while 19001's i_sum-first prior explains its 0/96; contextual gain/harm over each checkpoint's own prior: 20001 calibration CANONICAL recovers 9/9 of the prior's failures (membership forced, count informative) while harming 11, calibration PF 5/9 v 1, heldout C 0/9 with 7 harms; R = S_full - S0 feasibility: subtracting the 20001 prior costs 22/19/1/15 states. Existing populations hold only 13 matched-conflict states (ceiling 10/13) — a fresh balanced context-discriminating band with a predeclared fixed-ranking ceiling is the next design (GO PRIOR-RESISTANT-EVAL-DESIGN); FACTOR/HASH residual censuses parked until then. Desk census only, nothing loaded or run. RESULTS.md#L62394
- [NULL] [REGIME-SCOPED: calculus search] Prior-resistant band materialization NO-FIRE: the frozen CH-F3 horizon (1,920 bases, all qualified, 5,760 parents burned) fills only 16 of the 48 balanced t2/t3 pairs — the complete legal candidate set nearly determines the HCE-argmin teacher (gold = lowest i_unprod index in 1,728/1,920; 30/36 signatures single-gold; zero t2-and-t3 co-occurrence within a fixed inert-addend count k), and the only 16 fillable states come from identical index sets produced at different k (an inert addend shifts every term index by one; the frozen parity assignment coincided exactly with k, 960/960). Mechanically NO-FIRE under decision D; overlap and ceiling gates never executed; independently verified (zero discrepancies); successor needs a new prereg (vary which i_unprod guess wins while holding the index set fixed). RESULTS.md#L63074
- [MECHANISM-CONFIRMED] [REGIME-SCOPED: calculus search] Controlled-crossover desk fires: the two-pair skeleton d/dx[x^a sin(cx)] + d/dx[x^b cos(cx)] + Integral(sin(x)/x) + 21x^3 with one pair at exponent 2 produces STRICT state-dependent HCE teacher switches under a FIXED complete legal candidate signature — all 32 classifying primaries qualify, 16 STRICT-A (SIN_LOW) and 16 STRICT-B (COS_LOW) with zero ties and zero mapping violations, one complete cand_sig_id (i_sum + i_unprod term_index 1 + 4), gap exactly 1.0 HCE unit in 32/32 (residual count_ops 17 v 18; the child cancelling the high-degree pair wins), B1-B7 all pass, 0/192 overlap hits, verified by full re-qualification of all 192 burned parents; the e_lo = 1 robustness stratum reproduces the switch at a 3.0 gap. Deterministic construction, one desk, tiny legal set (3 candidates), support-asymmetric targets (A seen 394 times in training, B never) — a scoring confound, not a desk fact. GO V2 PRODUCTION DESIGN; nothing scored. RESULTS.md#L63897
- [MECHANISM-CONFIRMED] [REGIME-SCOPED: calculus search] V2 production band materialized and qualified: 144 fresh bases (e_lo = 1, e_hi {5,6,7,9}, c {29,31,37,41,43,47}, K {33x^3, 27x^4, 35x^3}) burned all 432 parents before qualification, 0 overlap hits, 432/432 qualified, all 72 matched pair keys eligible (FULL-RESERVE) under the exact frozen witness signature (i_sum + I0/t1 + I0/t3 + I0/t5), unique teachers with |gap| 3.0 in 96/96, pair_sha selection of 48 pairs (96 states, 48 A0 / 48 B0), both structural theorems verified over all 24 fixed orders (max top-1 48/96, both-correct pairs 0/48), companion I1/t1-v-t3 available 48/48, verified by full re-qualification. Disclosed: the SIN_LOW prompt is one token longer than its COS_LOW partner in 48/48 pairs (leading unary minus), so a length rule scores 96/96 — the scoring prereg must freeze nuisance-aware baselines and canonical candidate order before any score is read; targets support-substantial (2,267 v 257), never support-matched; I0/t5 unseen-symbol rival present. No model scored. RESULTS.md#L64676
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Raw-view scoring of the V2 matched-pair band (4 frozen checkpoints x FULL / MASK0, exact stored prompts, semantic candidate order, T = 9 total-sum law): state-conditioned ranking observed in 3/4 FULL checkpoints under the registered clause — seed 20001 CANONICAL 96/96 with 48/48 both-correct pairs and 48 correct-direction target flips, seed 20001 PARAM-FIRST 62/96 with 14/48, seed 19001 CANONICAL 29/96 with 0 both-correct but 19 robust top-action-switch pairs in the REVERSED direction (the switch theorem leg; the scorer's coded field counted 2/4, both counts booked), seed 19001 PARAM-FIRST exactly 48/96 predicting B0 everywhere (fixed-ranking class not refuted); all four MASK0 cells are a single fixed action with spread exactly 0.0 and pass every sanity; A0 is never the mask-0 top action (the registered frequency prior was wrong). SEMANTIC-BEYOND-SURFACE NOT IDENTIFIABLE: prompt-length, leading-sign and raw-order rules each score 96/96 on this artifact, so no cell is evidence of mathematical reasoning; deterministic single realizations, no inferential test, companion unscored. RESULTS.md#L65143
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Render-only counterfactual on the SAME 96 frozen states (object, gold, legal candidates, action codes and weights fixed; only the prompt rendering changed, read from the pinned views artifact): the legal-action ranking is causally sensitive to the registered render bundle in all four FULL checkpoints, and the two CANONICAL checkpoints reverse in opposite learned polarities under the same intervention — 20001 CANONICAL collapses 96/96 (48/48 both-correct) -> 48/96 (0/48) under both K-FIRST and LOW-PAIR-FIRST (48 COS_LOW states CUE-FOLLOWING CORRECT-POLARITY), 19001 CANONICAL rises 29/96 -> 48/96 -> 82/96 (34/48 both-correct; 54 states CUE-FOLLOWING REVERSED-POLARITY, 15 whole pairs), 19001 PARAM-FIRST leaves constant B0 for 95/96 (47/48) under K-FIRST (registered render-invariance prior refuted), 20001 PARAM-FIRST 62 -> 47 -> 17/96; RAW replay bit-exact 3,072/3,072 (drift 0.0), MASK0 cross-view spread exactly 0.0 in 4/4, zero SUBNOISE states, zero ties; independently verified. Fences: K-FIRST removes only the registered sign/length cues and still exposes theta (never surface-neutral); LOW-PAIR-FIRST flips a four-feature bundle (never sign alone); which feature is used is unidentified; the frozen SURVIVES reading is degenerate at RAW both-correct 0 and is booked as computed; semantic-beyond-all-surface NOT IDENTIFIABLE by construction; no pooling across seeds or representations; nothing trained. (RESULTS.md#L65490 "id:2026-09-02-verdict-math-cyber-1-prior-resistant-b-b-b")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Exhaustive render atlas: over the complete frozen class of 720 global role-permutation renderings of the same 96 states, each of the four frozen checkpoints (19001 / 20001 x CANONICAL / PARAM-FIRST) reaches the 96/96, 48/48 ceiling under some policy, but NO policy lies within 2 both-correct pairs and 4 top-1 states of all four individual optima simultaneously (near sets 6 / 46 / 91 / 13, intersection empty): finite-class render-preference incompatibility among the four learned solutions, not one weak checkpoint. The lexicographic-maximin discovery render (K, HI_D, LO_D, LO_L, HI_L, W) scores T 78 / 88 / 92 / 96 and B 30 / 40 / 44 / 48 and is the only UNIVERSAL-MAJORITY policy (1/720); UNIVERSAL-STRONG 0/720. RAW replay bit-exact 384/384 on all four; MASK0 spread 0.0; anchors reproduced. Two seeds, seed-correlated cells, discovery not validation, no p-values; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L65657 "id:2026-09-03-verdict-math-cyber-1-prior-resistant")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Fresh-initialization transfer of the atlas-maximin renderer: the renderer (K, HI_D, LO_D, LO_L, HI_L, W) selected by exhaustive 720-policy search on four discovery checkpoints was frozen, then four new seeds (21001 to 24001) were trained as paired CANONICAL / PARAM-FIRST realizations under the identical recipe and scored on the same 96 states under RAW and the frozen renderer only. NO PAIR-MAJORITY TRANSFER (0/4 seeds); the renderer reaches the majority floor (T >= 72, B >= 24) on 1/8 fresh checkpoints and removes 24 to 48 both-correct pairs on the three fresh checkpoints that sit at the ceiling under RAW; RAW itself spans 26/0 to 96/48 across the eight. Five of seven registered priors refuted in the over-optimistic direction. Out-of-sample across training initialization only (same evaluation states; mps realizations, not deterministic seed effects); n = 4 seeds, replication labels, no p-values; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L65784 "id:2026-09-03-verdict-math-cyber-1-prior-resistant-b")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Render-basin incompatibility is prevalent across fresh initialization: the complete 720-policy role-permutation atlas scored on eight fresh seeded checkpoints (seeds 21001 to 24001 x CANONICAL / PARAM-FIRST, same 96 states) shows every checkpoint reaching the 96/96, 48/48 ceiling under some rendering (near-optimal sets of 13 to 59 policies), yet no rendering is near-optimal for all eight, half the pairwise near-set overlaps are empty, and the best worst-case both-correct count achievable by one global rendering over the eight is 1 pair of 48 (fresh maximin render (HI_L, HI_D, LO_L, K, LO_D, W)); no policy is UNIVERSAL-MAJORITY on the eight or STATE-CONDITIONED-CORRECT on all twelve realized checkpoints; the discovery maximin R488 sits in no fresh basin; the discovery cohort's W-first universal-failure family holds on only 863/960 fresh cells. Characterization of twelve realizations of one recipe, no renderer validated, no population rate; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L65859 "id:2026-09-04-verdict-math-cyber-1-prior-resistant")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Cayley-graph render landscape (zero logits): on the adjacent-swap graph of the 720 role permutations, every one of twelve realized checkpoints (four discovery, eight fresh) has a fragmented high-performance region (MAJORITY sets in 2 to 29 components), optimum basins of at most 4.3 % of starts under strict ascent (the booked local-maximum count of 204 to 526 per B field is plateau-inflated: 137 to 494 per field are interior B = 0 floor vertices; corrected by AMENDMENT ...-CAYLEY-LANDSCAPE-0-PLATEAU, RESULTS.md#L65979 "id:2026-09-04-amendment-math-cyber-1-render-atlas"), and no path from the printer's default order to any counterfactual rendering along which no checkpoint loses both-correct pairs (COMMON-MONOTONE PATH ABSENT; RAW's monotone-reachable set is itself alone). The discovery compromise R488 is a local Pareto optimum of the four discovery fields and one swap from an optimum of three checkpoints, but is separated from every 19001 CANONICAL optimum by a both-correct = 0 valley (widest-path barrier 30 pairs); only 3 of 1,800 swaps raise all four discovery checkpoints strictly, 0 of 1,800 raise all eight fresh. Finite Cayley-graph description of these realizations; not a manifold, not circuits, no causal feature; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L65907 "id:2026-09-04-verdict-math-cyber-1-render-atlas")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Plateau quotient of the render-atlas landscapes (zero logits): after contracting tied neighbours, each of the twelve B fields has 10 to 61 quotient local maxima (8 to 51 strictly between floor and ceiling) against 204 to 526 strict-ascent fixed points, and each T field 10 to 59 against 163 to 492, so the T counts were plateau ties as much as the B counts; frozen classes put the four discovery B fields at one RUGGED, one INTERMEDIATE, two FLAT-WITH-FEW-PEAKS; on the discovery B fields quotient ascent carries 78 % to 97 % of starts to a ceiling plateau and the largest ceiling basin holds 77 % to 95 % (the strict-ascent 4.3 % was a floor artefact); every anchor inside a NEAR / MAJORITY / STRONG set and every median optimum sits exactly one adjacent swap from leaving it; both discovery Pareto fronts fall into 11 components; every field is smoother than all 200 relabelings of itself on the Cayley graph and concentrates its energy in low Laplacian modes. Finite description of twelve realizations; not a manifold, not circuits, no causal feature; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L66016 "id:2026-09-04-verdict-math-cyber-1-render-atlas-b")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] State-level decision atlas of the render atlases (zero logits, streams re-hashed): on every one of twelve checkpoints no frozen state keeps its top action across all 720 renderings, the per-state boundary fraction has median 10 % to 19 % of adjacent swaps on the discovery cohort, and a wrong decision is the pair partner's gold (A0 for B0, B0 for A0) in 92.7 % or more of wrong cells on both thetas; COS_LOW states are the hard ones (median renderers correct per state 65.5 to 169.5 of 720 against 545 to 649 for SIN_LOW), and the two members of a pair flip on largely different swaps (partner co-flip Jaccard below the non-partner median on 12 of 12), which is what keeps both-correct sets small; zero-flip edges are 97 % to 99 % of zero-delta-T edges on the discovery cohort, so unchanged T almost never hides compensating flips. Priors on SIN-hardness, partner co-flipping and universal fragmentation refuted. Finite description of twelve realizations; not a manifold, not circuits, no causal feature; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L66073 "id:2026-09-04-verdict-math-cyber-1-render-atlas-b-b")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Role-position census of the render atlases (zero logits, model-free conditioning of booked scores on role order): the only order effects shared by all four discovery checkpoints concern the SIN_LOW negative-bearing role HI_D relative to W: "HI_D before W" is the dominant precedence pair on both-correct pairs with the same sign on 4 of 4 (+5.6 to +16.9 pairs), HI_D last is the worst last role on 4 of 4 (by 0.02 pairs on one), and W last is the best W position on 4 of 4; role positions taken additively explain a minority of the both-correct variance on 3 of 4 (R² 0.33 / 0.46 / 0.84 / 0.38, W alone 0.06 to 0.35); best first role, dominant adjacency and the negative-term asymmetry are checkpoint-specific; the W-first failure family (120 / 120 at T 48, B 0 on discovery) does not extend one swap inward on the two CANONICAL checkpoints (94 and 92 of 120) and is universal on only 4 of 8 fresh checkpoints. Conditional means over a frozen finite class; not a manifold, not circuits, no claim about which surface feature the model reads; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L66121 "id:2026-09-04-verdict-math-cyber-1-render-atlas-b-b-b")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Matched transposition response of the render atlases (zero logits): decomposing the bank-G marginal effect "HI_D before W" exactly into 360 matched in-place swaps, the 120 direct adjacent HI_D<->W transpositions are the weakest of the five gap classes on all four discovery checkpoints (direct mean +0.8 to +10.4 pairs against +8.0 to +20.2 for the 240 non-adjacent swaps; largest gap mean at gap 4 or 5 on all four, up to +46.5), leave B unchanged on 55.8 % to 86.7 % of their contexts, raise B on all four checkpoints on 0 of 120, and are best in slot 0, 1 or 3, never the last; the both-correct changes are carried by the COS_LOW state flipping (COS-only 132 to 1,446 against SIN-only 7 to 46) while the swap lowers SIN_LOW correctness and raises COS_LOW correctness on all four discovery and all eight fresh checkpoints (by more on 11 of the 12). All four registered bars fail 0 / 4 and the fresh cohort reproduces the failures (7 / 8 and 8 / 8). Finite description; not a manifold, not circuits, no claim about which surface feature the model reads; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L66198 "id:2026-09-05-verdict-math-cyber-1-render-atlas")
- [SINGLE-SEED] [TEACHER-FORCED] [REGIME-SCOPED: calculus search] Nested decomposition of the matched HI_D<->W swaps (zero logits; 15 cells of 24 by gap and endpoint slot, sums of squares as partition identities): on 3 of 4 discovery checkpoints the within-cell part, which only the identities and order of the other four roles can carry, holds 57 % to 67 % of the sum of squares of the 360 both-correct deltas, against 21 % on 20001 CANONICAL where the HI_D-first slot dominates (position share 0.79); the gap-5 cell (endpoints 0 and 5, 24 interior orders) is all zero on 19001 C, near-constant at +46.5 on 20001 C, and spread 0 to +48 with 11 to 15 distinct values on the other two; at gap 4 the role placed just after W or just before HI_D separates sub-cell means by up to 31 pairs and interior orders span 0 to 48 within one cell. Three of four registered bars fail on at least 3 of 4; the fresh cohort reproduces the position-share failure (7 / 8) but not the W-last-cell ordering (2 / 8). Finite partition of booked deltas; not a manifold, not circuits, no internal feature inferred from an ordering effect; semantic_beyond_all_surface_identifiable = false. (RESULTS.md#L66247 "id:2026-09-05-verdict-math-cyber-1-render-atlas-b")

## Open checkpoint lifecycles

- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: measured deployment artifacts] Zero-training TRAINING-STAGE census of IFM/K2-Horizon-0.9B across eleven pinned tags (instrument qualified: rl-mopd_final v main bit-identical 255 / 255 with identical gate token ids; verifier 0 discrepancies): the `_final` tags are bit-identical relabels of the last numbered tag (pretrain_final = pretrain_600000, mid_1_final = mid_1_75000); the three-specialist merge moves the weights by 1.28e-3 relative and the 249-step distillation by 6.95e-5 (norms untouched in both, MLP layers 9-12 loaded), yet the raw-completion 120-item sympy gate rises 33 / 16 / 32 -> 43 / 23 / 40 at the merge tag (which also switches on YaRN; a one-seed rider attributes +6 of +10 to weights) and 0 / 0 / -1 under distillation; the second context-extension stage lowers the gate by 12 / 8 / 11; the distillation delta is the only strongly localized one (top-16 singular-vector IPR 94x uniform v 3.6x to 8.6x for training pairs). All three registered bars NO-FIRE (+10 / +7 / +7 against a strict +7; stage-profile Spearman 0.854 / 0.533 / 0.269 against at-or-below 0.5 on all three; distillation depth centroid 0.396 against above 0.5) and the registered prior on profile similarity was backwards (pretraining resembles the first context extension, the two context extensions do not resemble each other). One lineage, one device, three shot seeds whose offset (6 to 21, shared by all tags) exceeds most stage deltas in absolute size; no cross-scale reading; no mechanism or data attribution. (RESULTS.md#L66337 "id:2026-09-05-verdict-k2-horizon-stage-delta-census")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: measured deployment artifacts] Two residues of the 0.9B stage census, zero training. (A) Exact 2 x 2 weights x rope-config factorial on the frozen gate at three shot seeds, with both booked cells reproduced bit-exactly: the merge-tag gate rise is carried by the YaRN config (rope main effect +6 / +6 / +5.5) more than by the 1.3e-3 weight edit (+4 / +1 / +2.5), and the two are sub-additive (interaction −4 / 0 / −5; the weights add +6 / +1 / +5 without YaRN and +2 / +1 / 0 with it), refuting the additive "+6 weights, +4 config" reading. (B) Along the full published 0.9B chain (27 tags, 26 deltas) consecutive within-stage checkpoint deltas are anti-aligned at lag 1 on 21 of 21 pairs (pretraining median cosine −0.30 on all nine 10k-step pairs, every layer and matrix class; mid stages −0.01 to −0.13 at 5k), null at lag 2, weakly positive at lag 3 and at 50k spacing in pretraining (+0.13), so the effect lives at the published checkpoint period and is not a stage-boundary artefact; norm vectors flip sign across stages (+0.34 pretraining, −0.27 mid). Provenance: the hub re-pointed six 0.9B tags during the run with bit-identical shards, so later rungs fetch by commit and shard sha. One lineage, one device, no mechanism (optimizer, schedule and batch order unpublished). (RESULTS.md#L66404 "id:2026-09-05-verdict-k2-horizon-residues-0-a")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: measured deployment artifacts] 3.7B lifecycle signatures of K2 Horizon booked as the DISCOVERY half of a prospective 3.7B -> 7B transport rung (immutable manifests: full commit + per-shard sha256 checked before every open; 17 streamed tags; verifier 0 discrepancies). Of four 0.9B-derived bars two fire and two fail: consecutive 100k-step pretraining deltas are anti-aligned on 9 of 9 pairs with the median cosine growing from −0.004 to −0.212 along training; the pretraining endpoint and the first context extension share a 10-bin depth profile (Spearman 0.976); but the most localized structural edit is the first context extension (left-IPR ratio 12.0), not SFT (3.6), and SFT lowers 3 of the 4 open ladder families, so the 0.9B "post-training is the localized edit" reading is refuted at 3.7B. Centroids drift toward the output across the lifecycle (0.49 to 0.57, one dip) and the SFT profile is uncorrelated with the pretraining profile (−0.03). Under the registered law only four T4 candidate cells exist, so the 7B capability-direction bar books NOT-RESOLVABLE by law before any 7B value is read. One lineage, one device, two shot seeds, bf16 gates; no 7B tensor opened. (RESULTS.md#L66460 "id:2026-09-06-verdict-k2-horizon-transport-0-discovery")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: measured deployment artifacts] Prospective cross-scale transport of checkpoint-lifecycle signatures in K2 Horizon: with the 7B outcome sealed by immutable manifests (full commit + per-shard sha256) and five bars registered from the booked 3.7B values before any 7B tensor or logit was opened, the 3.7B signatures predicted the 7B signatures on four of four scorable bars: 10-bin normalized-depth delta profiles agree at Spearman 0.915 to 1.000 on 6 of 6 structural pairs; module-class delta-share vectors at 0.939 to 1.000 on 6 of 6; the six-pair localization orderings at 0.771 (left-IPR ratio) and 0.943 (normalized effective rank); consecutive 100k-step pretraining deltas are anti-aligned on 9 of 9 defined pairs at both sizes with the magnitude growing along training. The first context extension is the largest and most localized boundary edit at both sizes and the SFT profile is uncorrelated with the pretraining profile at both. Capability-direction transport is NOT-RESOLVABLE by the registered law (four candidate cells, six required) and is not claimed; the four descriptive cells are two sign agreements, one zero and one cell closed at 7B by a ceilinged family. The prediction held across two sizes of one family sharing corpus, schedule and config; one lineage per size, one realization each (single-seed by the glossary), one device, bf16 gates, equal depth 36, no mechanism, no data attribution, no scale law. (RESULTS.md#L66521 "id:2026-09-06-verdict-k2-horizon-transport-0-prospective")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: specified diet and recipe] ATOM-DIET-TRAJECTORY-1 (19M, one diet at one dose) ran all six paired stock / atoms births (seeds 5, 6, 7; 17 fixed snapshots each; all 24 gates post hoc after the six trainings) but books NOT-ADJUDICABLE: a documentation-only commit landed on the checkout while birth 2 trained, so births 2 to 5 carry a code_commit different from the launch commit and book NOT-RUN under the sealed abort clause (the instrument is byte-identical at both commits, the verifier's 25 discrepancies are all of the commit-identity class and none numerical, and the sealed text is not reworded after the data). The one adjudicable cell, the seed-5 pair, reads atoms 71 v stock 65 (+6, L4 10 v 8) at n = 1. Every six-birth quantity is reported descriptively as the re-run's comparison target and shows the REFUTED-IF pattern the registered priors predicted (paired lift +6 / +8 / +6, mean +6.67; 8-layer update-energy displacement 0.0156 to 0.0241 inside the within-arm spread 0.0119 to 0.0350, min-over-max 0.447 and never above 1 at any snapshot; treatment-vector cosines 0.92 / 0.26 / 0.08; centroid signs mixed). No bar, prior or claim axis is adjudicated; the lesson booked is no commit of any kind to a live registered checkout and a HEAD-v-launch-commit guard at every receipt write. One device (mps fp32, run-level nondeterministic, arm order counterbalanced 2:1), no WEIGHTS -> FUNCTION, mechanism or scale claim. (RESULTS.md#L66991 "id:2026-09-07-verdict-atom-diet-trajectory-1-not")
- [NULL] [DEVICE-SCOPED] [REGIME-SCOPED: specified diet and recipe] ATOM-DIET-TRAJECTORY-1, adjudicated on the provenance-repaired six-birth evidence set (seeds 5, 6, 7; the two valid seed-5 births retained byte-identical and the four commit-drifted births plus all 24 gates rerun at the original launch commit in a detached worktree; verifier VERIFIED, 0 discrepancies, one code_commit): the 3.5% one-ply atom diet reproduces its paired 120-gate lift at 3 / 3 seeds (+6 / +3 / +10, mean +6.33 against the sealed +5 clause; L4 10 / 11 / 13 v 8 / 7 / 5), so the direction is five-for-five across matched-horizon seeds 3 to 7 while the magnitude stays within one resolution unit of the 7-solve bar; but its paired displacement of the 8-layer normalized update-energy profile (0.0146 to 0.0241) never exceeds the within-arm birth spread (0.0112 to 0.0344; min-over-max 0.425 at 15,420 and never above 1 at any of 16 snapshots), the class-share and centroid bars also no-fire, and only the direction of the treatment vector reproduces (cosines 0.90 / 0.30 / 0.10). Under the sealed law STRUCTURAL no-fires, FUNCTION fires, the REFUTED-IF branch lands as the registered priors predicted, and the K2-derived macro-trajectory-signature-as-data-lever program STOPS at this house scale: at this dose and scale, where the update energy lands does not identify the diet. One device (mps fp32, run-level nondeterministic; same-seed reruns of seeds 6 and 7 moved the per-seed function delta by 5 and 4 solves), n = 3 paired seeds, no WEIGHTS -> FUNCTION, mechanism or scale claim. (RESULTS.md#L67274 "id:2026-09-08-verdict-atom-diet-trajectory-1-repair")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] WRITER-TRAJECTORY-CENSUS-0, zero training on existing checkpoints (verifier VERIFIED, 0 discrepancies): on one byte-identical seed-2 initialization the forward and backward OneCycle writers of the 19M model (both backprop + AdamW; the intervention is the stock OneCycle scheduler, LR cycled with beta1 cycled 0.95 -> 0.85 -> 0.95, versus a backward SequenceLR, the LR sequence reversed with beta1 fixed at 0.9: two optimizer fields differ per step, AMENDMENT WRITER-INTERVENTION-SCHEDULER-LAW RESULTS.md#L73710) diverge in weight-trajectory coordinates far beyond the observed same-writer mps rerun envelope of four nearby specimen pairs: final cumulative cosine 0.211 v null minimum 0.777, relative divergence 1.256 v null maximum 0.668, mid-training velocity-cosine median 0.021 v null minimum 0.304, all 8 blocks below their block-wise null; they land in one gate band (64 / 62; null pair 61 / 64) yet their learned-update DEPENDENCE profiles differ (9-group distance 39.4 v same-writer 9.6; reverting the forward writer's first two blocks costs 32 and 29 solves, the backward writer's 7 and 6, whose last block carries 62), and a block delta moved across writers costs 6 to 31 solves against 0 to 7 within one writer (cross median -11.5 v null worst -7, ranges overlapping at one block). Under the sealed law TRAJECTORY, DEPENDENCE and COMPATIBILITY all fire; the registered D-1 NO-FIRE prior missed. Reading, bounded: writer-contingent dependence structure even between two backprop schedules, incompatibility only (co-adaptation, basis and scaling stay live), no mechanism or algorithm claim; the DFA foreign-writer ladder's GO conditions are met and its STOP clause is comfortably not triggered (the sealed clause needs the null distance within 20% of the writer distance, i.e. at least 0.8 x 39.4; the null is 9.6, about one quarter; reading corrected by AMENDMENT WRITER-TRAJECTORY-CENSUS-0-STOP-READING). One writer pair, one dependence null pair, trajectory coordinates licensed only by the shared W_0, gates at sigma about 5 on mps. (RESULTS.md#L67980 "id:2026-09-09-verdict-writer-trajectory-census-0-trajectory")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] WRITER-DEPENDENCE-NULL-2, null strengthening under the first mechanical live-run interlock (verifier VERIFIED, 0 discrepancies): a second same-writer rerun pair (stock_s7 first run v repair, gates 63 / 61) reads a 9-group learned-update dependence distance of 9.85 and an 8-class distance of 7.81, with same-writer block swaps between -5 and +5 solves, so the WRITER-TRAJECTORY-CENSUS-0 readings stand under their frozen reassessment law (9.85 < 31.5; no swap <= -11.5) and the two-pair same-writer envelope for the foreign-writer rung is 9.85 (depth), 10.34 (class), -7 (worst swap); depth-profile shape varies across seeds within one writer while the paired distance stays near 10. Descriptive, one added pair, mps gates at sigma about 5. (RESULTS.md#L68265 "id:2026-09-09-verdict-writer-dependence-null-2-null")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] WRITER-DFA-1, the first foreign credit-assignment writer, STOPS at its sealed qualification ladder as DFA-UNSTABLE: all four Direct Feedback Alignment cells ((s, lr) in {(1, 3e-4), (1, 1e-4), (0.25, 3e-4), (4, 1e-4)}, seed 21, macro DFA with random feedback after every block, AdamW + OneCycle, the pinned stock stream, 15,420 steps, mps fp32) finish with finite loss at 3.34 to 3.51 (uniform 3.69) and gate 0 / 120 at 0.0% validity, so no cell is STABLE, nothing is selected, no seed-2 birth is licensed and the matched-function mechanism comparison is NOT RUN; accessibility only, no mechanism / dependence / compatibility claim, FUNCTION-BAND prior a miss (band unreachable), five conditional priors unscored (family 5 hits, 2 misses); the writer-integrity smoke (nine invariants, BP parity 0.0) certifies the credit path is the registered one, so the plateau is a property of the sealed DFA regime at this width and horizon, not a known implementation defect. Every process ran under the liverun interlock with no mid-run commit. RESULTS.md#L68802
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] CREDIT-ANCHOR-FRONTIER-1 books FRONTIER-CLOSED: with the top k in {1, 2, 4} blocks (plus head and norm) on exact backprop over a lower stack trained by direct random feedback (the WRITER-DFA-1 B_l law), all six hybrid cells at seed 23 gate 0 / 120 at 0.0% validity (loss 3.15 to 3.29, uniform 3.69), so no candidate exists and DFA-family births STOP by the sealed law; the registered zero-credit controls (same top blocks by backprop, lower stack and emb frozen at W_0) gate 28 / 55 / 62 at k = 1 / 2 / 4 (62 is inside the 61 to 65 of the registered stock births), so by the sealed interpretation the DFA-trained lower stack is actively harmful at every k; priors: k = 1 miss hit, k = 2 and k = 4 reach-the-floor missed, ladder-stops-at-2 missed, band unscored (family 6 hits, 5 misses); every process under the liverun interlock with no mid-run commit; descriptive controls, one seed, no mechanism claim. RESULTS.md#L69409
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] DFA-LOWER-HARM-DESK-0, zero training on the seed-23 frontier specimens: transplanting the DFA-trained lower package (emb + blocks 0..7-k) under a backprop top segment that gated 28 / 55 / 62 on W_0 features drops the gate to 0 / 120 at k = 1, 2, 4, and restoring W_0 below the failed hybrid top recovers nothing (0 / 120 at every k); with the registered support law met (every hybrid's residual stream is rank 1.0 to 1.6 at every block from step 463, the zero controls keep W_0's rank 20 to 23 below the boundary and reach 15 to 63 above it), the rank-collapse reading of the DFA failure is SUPPORTED as an intervention result on one seed: the B_l e lower stack is sufficient to destroy a working top, and a top grown on the collapsed stream does not compute on W_0 features; alignment on the DFA blocks stays under 0.03; descriptive, no bar, no 'necessary' claim. RESULTS.md#L69604
- [REPLICATED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] FROZEN-BACKBONE-1 REPLICATES the seed-23 frozen-random-backbone observation on three fresh paired seeds (24, 25, 26): with the embedding and blocks 0..3 frozen bit-exactly at W_0 and only blocks 4..7 + norm + head trained by the stock backprop recipe (15,420 steps, pinned stream, mps), the frozen arm gates 63 / 61 / 59 against same-W_0 full-backprop controls at 61 / 64 / 62 (delta +2 / -3 / -3, all >= -7, controls adequate at >= 24); registered reading only: at this task / scale, learning the embedding and bottom four blocks is not required to reach full-BP function at the house gate resolution across these specimens; the frozen stack is not called irrelevant and no mechanism is read (RESULTS.md#L70024 "id:2026-09-10-verdict-frozen-backbone-1-replicates-on").
- [REPLICATED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] SG-PREDICTOR-AUDIT-0 (zero main-model training, twelve FROZEN-BACKBONE-1 states on three seeds): the true backprop hidden-error targets delta^BP_l are numerically healthy (0 nonfinite, 0 exact-zero token norms over 190,680 eligible tokens) but five to six decades below unit scale (element RMS 7.5e-7 to 7.8e-6, per-token-norm dynamic range 5.3 to 6.1 decades on trained states), so the registered trigger fires and fixed per-block normalization constants are booked for the synthetic-gradient writer (arena s_4..7 = 5.46e-6 / 4.48e-6 / 3.56e-6 / 2.44e-6; full-stack s_0..7 = 4.28e-6 .. 1.84e-6; BS-32 mean-CE grain only); descriptive, no gate read, no predictor capacity chosen (RESULTS.md#L70301 "id:2026-09-10-observation-sg-predictor-audit-0-true").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] SYNTHETIC-GRADIENT-WRITER-1 qualification books ACCESSIBILITY-ONLY: at seed 27 over a frozen random backbone (emb + blocks 0..3 at W_0) the paired frozen-BP control gates 59 / 120 and the four sealed synthetic-gradient cells (LINEAR and MLP-256 per-token predictors at predictor LR 3e-4 and 3e-5, fixed audited target constants, same-pre-update teacher targets, elementwise normalized MSE) gate 1 / 0 / 0 / 0 outside the c +- 7 band; the predictors never beat the zero predictor beyond 4 % at any logged step and cos(hat_delta, delta^BP) stays within +-0.23 on every block; no recipe frozen, no full-stack discovery follows; the second foreign credit writer is inaccessible at qualification on this arena (RESULTS.md#L70832 "id:2026-09-10-verdict-synthetic-gradient-writer-1-qualification").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] SG-FAILURE-DESK-0 (zero main-model training on the retained SYNTHETIC-GRADIENT-WRITER-1 states, 46 model + 36 predictor snapshots, closed-form float64 oracles on an interleaved FIT / HELDOUT probe split): the registered per-token synthetic-gradient input (x_l+1, e_t) does not linearly represent delta_BP even on the healthy frozen-BP control (held-out least-squares ratio 0.31 at step 463, 0.95 to 1.09 from step 3,084 on; a 2048-feature random-feature oracle no better), the online predictors are BAD on all four SG cells with no tracking lag, and the two MLP-256 cells show an SG-only representation collapse (effective rank 1.0 at every credited block by step 463 on the 3e-4 cell) coinciding with the target fall while head / norm norms stay within 9 % of the control; branch C (formulation) and D (self-induced collapse) hold on the MLP cells, A on none; descriptive, no mechanism claim (RESULTS.md#L71182 "id:2026-09-11-observation-sg-failure-desk-0-on").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] SG-CROSSPOS-REPRESENTABILITY-0 (zero main-model training on the retained seed-27 frozen-BP control, ten snapshots x blocks 4..7, a fixed-capacity reverse-causal sequence predictor reading [x_l+1, e] at the positions j >= i, offline fit on the interleaved FIT half, scored on HELDOUT): BAR-1 NO-FIRE, late median zero-baseline ratio 1.10 (blocks 4..6 0.93 to 1.29 at every late step; block 7 alone 0.10 to 0.12), and the paired same-architecture LOCAL (j == i) arm is indistinguishable (per-cell gap median -0.008, range -0.076 to +0.023), so cross-position access adds nothing; the fits memorize (FIT 0.19 to 0.34 v HELDOUT 0.93 to 1.29); the SG family closes at this arena as sealed; the information-hole hypothesis is refuted within this family and budget, not in general; prior 3 hits 3 misses (RESULTS.md#L71557 "id:2026-09-11-verdict-sg-crosspos-representability-0-bar").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] SG-BOUNDARY-BLOCK7-1 (seed 28, frozen-random-backbone arena; blocks 4..6 exact BP through the true block-7 Jacobian with detached parameter views, block 7 credited only by a LOCAL synthetic gradient from (x_8, e), one frozen predictor recipe): SG7-MISS, the cell gates 37 / 120 against the paired frozen-BP control's 64 (band 57 to 71) despite ending within 0.015 nats of the control's training CE and a predictor that beats the zero predictor at 64 of 87 logged steps (final MSE ratio 0.58, final cos 0.68); SG credit-writer births close completely as sealed; no writer-invariance or causal-efficacy claim; prior 4 hits 2 misses (RESULTS.md#L71955 "id:2026-09-11-verdict-sg-boundary-block7-1-sg7").
- [NULL] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] MEZO-SIGNAL-DESK-0 (two seeds, one arena; zero training; seed-27 / seed-28 frozen-backbone control states at four steps x two fixed batches; exact BP gradient as diagnostic oracle; 64 fixed Rademacher perturbations per family): the antithetic zeroth-order estimate is faithful at eps 1e-3 (sign agreement 0.995, relative error 2.4e-3) and carries exactly the isotropic SPSA signal, cosine 5.8e-4 to the BP gradient at m = 4 (0.90 of sqrt(m/d), d 9.46M) and 2.6e-3 at m = 64 (1.00 of it); finite differencing costs nothing; the rank-1 tensorwise structured family is indistinguishable from vanilla (cosine ratio 0.95 to 1.02); the line-optimal descent ratio of a practical m = 4 zeroth-order step to a BP step is 1.65e-2 (vanilla) / 1.58e-2 (rank1), six times below the registered 0.1: PARK, the foreign-writer program parks; grid-capped fence on the zeroth-order side stated; prior 7 hits 2 misses (RESULTS.md#L72285 "id:2026-09-12-verdict-mezo-signal-desk-0-park").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] VERIFIED-ENDOGENOUS-DATA-CROSSFOSTER-1-DONOR (zero training; the seed-2 forward / backward OneCycle specimens as donors, one identical oracle-verified one-step generation law on a fresh 24,000-root population, matched-root matched-dose K = 1 retention): DONOR-HISTORIES-DEGENERATE, the two function-matched donors' verified next steps coincide canonically on 5,588 of 6,000 retained rows (93.1 %, above the registered 90 % stop), no self-preference in cross-model CE beyond 0.003 nats, the union of all verified rows overlaps 89 to 92 %; the four-cell cross-fostered replay rung is NOT BANKED as designed (its data contrast would be 0.24 % of the recipient stream); the identity of a verified one-step history is set by the roots and the oracle, not by this writer contrast; prior 5 hits 1 miss (RESULTS.md#L72632 "id:2026-09-13-observation-verified-endogenous-data-crossfoster-1").
- [NULL] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] VERIFIED-ENDOGENOUS-DATA-CROSSFOSTER-1-CHAIN-DESK (zero training; the same seed-2 forward / backward donors walking paired verified chains from 24,000 fresh roots under common sampling seeds, horizon 12, retained at >= 2 plies, 6,000-row matched projection): CHAIN-DEGENERATE, min-side donor-specific rows 772 of 6,000 (12.9 %) against the registered licensing bar of 3,000; iteration is visible (20.4 % of pairs diverge, divergent fraction 0.076 at ply 1 to 0.176 at ply 2, the one-step 6.9 % row contrast roughly doubles) but chains end within 2 to 4 verified steps on this root generator (no pair reaches the 12-ply horizon), so it cannot compound further; the program is PARKED as sealed; prior 7 hits 2 misses (RESULTS.md#L72990 "id:2026-09-14-verdict-verified-endogenous-data-crossfoster-1").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] UPDATE-GEOMETRY-CENSUS-0 (zero training; the seed-2 forward / backward OneCycle pair at seven matched times plus a same-writer final-state null; 64 frozen stock batches split FIT 32 / HELD 32; exact trainer-CE gradients over all 18.9 M parameters; Gram algebra; isotropic reference): the FIT-derived top-8 task-gradient subspace reproduces on held-out batches (reliability S_8 0.39 / 0.40) but captures only a median 0.25 / 0.27 of a held gradient's energy at k = 8 and 0.37 at k = 16 (five orders above random, below the 0.5 STABLE-THIN bar): PARTIAL-THIN; centering changes nothing at the finals (mean direction negligible, Q 0.02); the two writers' subspaces on the same batches overlap 0.645 at k = 8, above either writer's cross-batch reliability and below the same-writer rerun pair (0.88): WRITER-SHARED, the leading gradient directions belong to (function, batch) more than to the writer; W_0 is one shared descent direction (C_8 0.94, Q 0.73) that training DIFFUSES (participation ratio 1.7 to 14); descriptively the finals' capture lives in embedding / head / norm (77 to 80 % of gradient energy) while transformer blocks read 0.005 to 0.03, and the checkpoint velocity lies almost entirely outside the top-16 gradient subspace; no projected-gradient rung is licensed; prior 4 hits 7 misses (RESULTS.md#L73446 "id:2026-09-14-verdict-update-geometry-census-0-resolved").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] OPTIMIZER-GEOMETRY-DESK-0 (zero training; the stock-OneCycle / backward-SequenceLR pair at steps 900 / 7200 / 13500 with their stored Adam state, one counterfactual AdamW step per probe batch on the UGC0 panel): GEOMETRY-NOT-RESOLVED under the sealed gate (the full write's top-8 FIT subspace does not reproduce on HELD, S_8 0.13 to 0.25) because the write is ONE common direction per state (participation ratio 1.1 to 1.7, Q 0.73 to 0.94) set by the carried first moment (the zero-gradient write u_0 is 85 to 96 % of the full write's norm), the batch-sensitive remainder b = u - u_0 is near-random across batches (held C_8 0.01 to 0.08 late, reliability 0.06 to 0.16) and less reusable than the raw gradient it came from, the deformation enters at g -> first moment (D 1.9 to 3.9) not at the preconditioner (D 0.02 to 0.14), and the two writers' write directions are unrelated (S_8 0.002 to 0.005) while their gradients overlap 0.5; the raw gradient reproduced UGC0 exactly; descriptively the chain would have read HISTORY-DOMINATED; no training rung licensed; OPTIMIZER-MEMORY-ABLATION-1 banked unarmed; prior 6 hits 6 misses (RESULTS.md#L74103 "id:2026-09-14-verdict-optimizer-geometry-desk-0-geometry").
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] OPTIMIZER-MEMORY-ABLATION-1 STAGE 0 (native-state resume preconditions on the stock-OneCycle A and backward-SequenceLR B writers at the stored step-7200 state, 900-step legs on the reconstructed future stream: CPU-deterministic C / C' plus two native mps resumes each, against the booked m008100): NOT-ADJUDICABLE as sealed. A PASSES every precondition (C = C' bit-exact at h = 1 / 5 / 20 / 100 / 900; scheduler rows 7200 / 7201 exact; first step v the virtual law 1.05e-3 float32 / 2.1e-12 float64; CPU and both mps resumes reproduce the booked leg to 8.2e-5 / 2.4e-5 of its norm at unchanged held CE). B exceeds the registered mps native-resume envelope: from the same stored state and stream its two independent native mps resumes end 0.217 of the leg apart and 0.259 / 0.205 from the booked state (cap 0.25), the CPU continuation 0.330, all four legs equal in norm with pairwise cosines 0.95 to 0.98 and held CE unchanged to 3e-5: substrate-level numerical sensitivity of this registered continuation in parameter space at nearly unchanged function, source and scheduler cause not established. The two-writer Stage 1 is closed; no Z / E treatment runs under OMA1; B is not moved to a hand-picked anchor (a schedule-phase census across frozen anchors is the pre-registerable follow-up, banked unarmed). Single-writer PRE-REG FIRST-MOMENT-ERASURE-1 on A designed and banked, not run. (RESULTS.md#L74856 "id:2026-09-14-verdict-optimizer-memory-ablation-1-stage")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] FIRST-MOMENT-ERASURE-1 (writer A = stock OneCycle seed 2 only, stored step-7200 state, 900-step CPU-deterministic legs on the reconstructed future stream against the pinned OMA1 Stage-0 control; Z = exp_avg <- 0 with exp_avg_sq / optimizer age / weights / scheduler / batch order preserved; E = 0.99 exp_avg): PERSISTENT-SPECIFIC + FUNCTION-NEUTRAL under the frozen bars. The erasure is reproduced exactly on the first step (n_Z(1) 0.894284643 v the sealed 0.894284653), the Z and E deviations are collinear and proportional through h = 5 (linear response; r 1.000 / 1.000 / 0.991 / 0.890 / 0.280 at h = 1 / 5 / 20 / 100 / 900), the normalized deviation never decays below 0.23 of the control's own displacement (n_Z 0.894 / 0.634 / 0.441 / 0.233 / 0.452), the 1 % twin stays small (n_E(900) 0.016), and the HELD-32 CE is unchanged throughout (dCE_Z(900) -0.0013 v the 0.005 bound; descriptive gate C 53 / Z 56 inside the 7-solve fence): on this writer and anchor, erasing the carried first moment moves the path and not the function. Not settled by the receipts: the h = 900 separation is not attributable to the erased content specifically, since between h = 100 and 900 the twin's deviation grows faster than Z's (6.1x v 4.6x), the two deviations become nearly orthogonal (cos 0.07) with the same group-share profile, a magnitude-independent late growth mode of the leg. Single writer, one anchor, one seed lineage; OMA1 stays NOT-ADJUDICABLE and writer B is untouched; longer-horizon A leg and OPTIMIZER-MEMORY-CROSSFOSTER-1 banked unarmed with a magnitude-ladder control. (RESULTS.md#L75193 "id:2026-09-15-verdict-first-moment-erasure-1-persistent")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] FIRST-MOMENT-ERASURE-LADDER-1 (writer A = stock OneCycle seed 2 only, stored step-7200 state, the registered eps ladder 1e-3 / 1e-2 / 1e-1 / 1 on exp_avg <- (1 - eps) exp_avg with a frozen one-step preflight before any long leg): NOT-ADJUDICABLE (REGIME-UNRESOLVED) exactly as sealed. The preflight refused on the eps = 1e-3 arm (R(1) 1.00126 v the 1e-3 tolerance; cos to the eps = 1 direction 0.99869 v 0.999) while the three larger arms sit on the analytic first-step law (R 1.0000132 / 1.00000033 / 1; cos 0.99999 / 0.9999999 / 1; n_1(1) 0.894284643 = the sealed value to 1e-8; fresh binds reproduce the locked Stage-0 C and FME1 Z / E h = 1 digests bit-exact). No long leg ran: no BAR 0 / 2 / 3 / 4 / 5 value, no regime, no function reading, no substrate readout exists; the rung's one shot is spent, no relaunch without a new prospective amendment. Descriptively, a 1.24e-4-norm first-step perturbation over 18.9M float32 parameters is the scale at which the intervention stops resolving to 1e-3; the ladder is linear in eps down to 1e-2 at the first step (slope 0.99984). Prior 'BAR 1 passes: 0.90' MISSED. FME1 (L75193) untouched. (RESULTS.md#L75795 "id:2026-09-15-verdict-first-moment-erasure-ladder-1")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] FIRST-MOMENT-ERASURE-LADDER-2 (writer A = stock OneCycle seed 2 only, stored step-7200 state, four fresh continuous CPU-deterministic legs 7201..15420: C and exp_avg <- (1 - eps) exp_avg for eps = 1e-2 / 1e-1 / 1, the float32-resolved range; 12-horizon grid): INTERMEDIATE + FUNCTION-NEUTRAL under the frozen bars. Linear, direction-shared response through h = 100 (R within 0.13 of 1 on the two informative arms, both decade slopes in [0.80, 1.20], cosmin 0.90; h_lin = 100), decorrelation and curvature onset by h = 900 (cosmin 0.069, decade slopes 0.958 v 0.489; h_dec = h_curve = 900), then a separation settled in magnitude from the epoch boundary and in direction once the schedule has cooled (self-rotation 0.997+ from h = 7200), to H = 8220: n 0.171 / 0.301 / 0.470, alpha_global 0.220 (v the 0.20 TRAJECTORY-SENSITIVE bound; local slopes 0.246 / 0.194), cosmin 0.191, R(1e-2) 36 (a 100x amplitude difference ends as 2.8x in norm), cooled-tail ratios 0.995..0.999. HELD-32 CE unchanged in every arm (|dCE(H)| <= 4.5e-5; never above 0.0023 at any horizon); descriptive gate C 64 = e1 64 = the booked historical model 64 / 120. Descriptive substrate: the CPU continuation lands 0.031 of the booked model's displacement from the native mps run at 15300 / 15420 with the CE equal to 3.3e-5 and, at 15420, the same gate dict. The registered TRAJECTORY-SENSITIVE cell was missed by 0.020 on alpha_global alone; neither REFUTED-IF fired. Priors 11 / 1. Single writer, one anchor, one seed lineage; eps >= 1e-2 only; no direction control in this family (content specificity not claimed). FMEL1 (L75795) and FME1 (L75193) untouched; matched-norm random-direction control and the schedule-phase census banked unarmed. (RESULTS.md#L76340 "id:2026-09-15-verdict-first-moment-erasure-ladder-2")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] RANDOM-DIRECTION-CONTROL-1 (writer A = stock OneCycle seed 2 only, stored step-7200 state; fresh C plus three seeded random exp_avg directions (2026091501 / 02 / 03) drawn isotropically in exp_avg space and matched per group under the exact first-step write metric to the booked FMEL2 eps = 1e-1 moment-axis write (same norm, same nine-group shares, orthogonal group by group; the booked eps = 1e-1 snapshots as locked comparison vectors); four fresh continuous CPU-deterministic legs 7201..15420, 12-horizon grid): MIXED + DIRECTION-INDEPENDENT-LATE + FUNCTION-NEUTRAL under the frozen bars. Fresh C bit-exact to the locked FMEL2 C at all 12 horizons; construction preflight passed on realized quantities (magnitude within 2.1e-7, |cos| to the moment write <= 1.6e-7, share gap <= 1.6e-7, pairwise |cos| <= 6.3e-5). The random deviations track the moment axis's linear phase through h = 20 (A 1.00 to 1.06), stall at 9.3x over h = 100..300 while the moment axis grows and rotates, reach 10x at h = 900 (moment axis: h = 100), take their large step one grid horizon after the moment axis (h = 1800 v 900) and settle by h = 4500 at 195x / 286x / 210x against the moment axis's 517x: A_r(H) 0.376 / 0.552 / 0.406 (one inside [1/2, 2], two below, all above 1/4; the three within 1.47x of each other), n(H) 0.113 / 0.166 / 0.122 v 0.301, cos to the moment-axis deviation at H 0.18 / 0.24 / 0.22, random-v-random 0.14 to 0.39, self-rotation 0.9999 for every deviation at H, the same late anatomical profile in every arm (BLOCK7 share 0.134 -> 0.04). HELD-32 CE unchanged (|dCE(H)| <= 1.45e-4; <= 2.4e-4 at any horizon); descriptive gate C 64 = R2 64 = R3 64, R1 65. Reading (fenced): late amplification on this arena is largely direction-generic in magnitude (within 2.7x) with a consistent moment-axis excess of 1.8x to 2.7x and an earlier onset; neither REFUTED-IF fired; this concerns late-amplification specificity only, not the FME1 initial-branch claim, and the random exp_avg perturbations are 0.17 of the moment-axis one in state norm (descriptive, not matched), so no unconditional pure-direction claim. Priors 6 / 2 (modal BAR 2 prior DIRECTION-GENERIC missed; h_amp <= 300 missed). Single writer, one anchor, one seed lineage, three directions, one write norm and locus profile. Consequence for MIXED is Artin's decision; nothing launched. (RESULTS.md#L77202 "id:2026-09-17-verdict-random-direction-control-1-mixed")
- [SINGLE-SEED] [DEVICE-SCOPED] [REGIME-SCOPED: house crystals] PERTURBATION-RESPONSE-GRAM-DESK-0 (zero training on the booked RANDOM-DIRECTION-CONTROL-1 C / R1 / R2 / R3 snapshots and the locked FMEL2 eps = 1e-1 moment-axis snapshots, writer A at anchor 7200, 12 horizons, float64 flats under the 59-tensor law; every sha and state digest asserted; re-derived norms and cosines equal the locked RDC1 values exactly): the four deviations are four independent directions through h = 300 (normalized Gram top / trace 0.25, participation rank 4.00), acquire one shared component from h = 900 (top / trace 0.375) that settles by h = 4500 at 0.431 with participation rank 3.36, uniform across BLOCK0..7 from h = 3080 on (0.425 to 0.435 at H; OUTSIDE 0.464) and earliest in the lower blocks; consecutive-window increments are window-local (every lagged cross-cosine between different windows of different arms |cos| <= 0.09; the registered PRIMARY cell cos(D_M(300 -> 900), D_R(900 -> 1800)) = 0.014 / -0.010 / 0.002 and every lagged alternative within 0.09 of zero in every group), while SAME-window coupling is substantial: sign-indefinite in the moment axis's growth window 300 -> 900 (cos to M -0.34 / -0.38 / +0.28, R1 | R2 0.64; top eigenvector a contrast with eigenvalue 2.07 of 4, the panel's increments 21x to 37x smaller than M's there), near zero in the panel's own growth window 900 -> 1800 (0.02 / 0.10 / 0.07), uniformly positive from 1800 on (0.21 to 0.38 to M, 0.13 to 0.45 among the random arms). Descriptive, no bar, no label; changes no verdict; the moment-axis excess is attributed to neither direction nor magnitude. Expectations 2 HIT / 2 MISS of 4 (the PRIMARY-cell null held; the same-window coupling and the random-only window sharing were both stronger than expected). Recommendation only (Artin decision): a perturbation-phase census over an optimizer-memory cross-foster as the next prospective rung; keep-set proposal recorded, nothing pruned. (RESULTS.md#L77655 "id:2026-09-17-observation-perturbation-response-gram-desk-0")
