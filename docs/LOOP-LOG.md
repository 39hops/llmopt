...
| 45m run 3 (small cycles, from consol2) | two-tier gates | 24 cycles @ --groups 16, proxy N=8 off-cycles, snapshot-before-verdict, solves-primary | launched from 65 @ 63.05 | — | LIVE overnight (spec 2026-07-17-run3-small-cycles) | ~8m/cycle target |
