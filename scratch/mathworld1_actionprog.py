"""MATH-CYBER-1 ACTIONPROG-QUAL-0 — semantic ActionProgram
decoder qualification on the frozen corpus (per outside review
of ACTION-BASIS-DESK-0; no lengths are measured here).
...
anatomy only; NO length thresholds here).
    ...
    .venv/bin/python scratch/mathworld1_actionprog.py   (Mac)
"""
import hashlib
import json
import sys
...
OUT = Path("logs/mathworld1/actionprog_qual.json")
