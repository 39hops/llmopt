"""MATH-CYBER-1 SVP-GRID-CALIBRATION-SCORE-17001 — ONE scoring
run of the two sealed seed-17001 checkpoints on the frozen
...
Outputs under logs/mathworld1/svpcalscore17/ (refuse-if-exists):
scores.jsonl, svpcalscore17_receipt.json, riders.json.

    .venv/bin/python scratch/mathworld1_svpcalscore17.py      (Mac)
"""
import hashlib
import json
import sys
...
OUTDIR = Path("logs/mathworld1/svpcalscore17")
TOK = ActionGCTok()
...
def main():
    ...
    (OUTDIR / "svpcalscore17_receipt.json").write_text(
    ...
    print("[svpcalscore17] DONE", flush=True)
    return 0
