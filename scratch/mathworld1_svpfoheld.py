"""MATH-CYBER-1 SVP-FIELD-ORDER-KNOWN-SET-HELDOUT-ONSET-SCORE-
19001 — stage 3 (final scoring stage) of the frozen FIELD-ORDER
protocol (prereg 3ac5a70e), under live calibration authority
(FIELD-ORDER CALIBRATION FIRED, receipt byte-pinned). ONE joint
prefix-scoring run of the two sealed seed-19001 checkpoints
...
Outputs under logs/mathworld1/svpfoheld/ (refuse-if-exists):
raw_token_scores.jsonl, svpfoheld_receipt.json, riders.json.

    .venv/bin/python scratch/mathworld1_svpfoheld.py         (Mac)
"""
import hashlib
import json
import math
...
CAL_RECEIPT = "logs/mathworld1/svpfocal/svpfocal_receipt.json"
...
PINS = {
    HELD:
        ...
        "b4509df46ddb",
    CAL_RECEIPT:
        "f5e3be58c76982e8af908d1c34497606757932909d63be964866"
        "0a92eb3039a4",
    CENSUS_JSON:
...
OUTDIR = Path("logs/mathworld1/svpfoheld")
TOK = ActionGCTok()
...
def main():
    ...
    gate(cal["verdict"] == "FIELD-ORDER CALIBRATION FIRED",
    ...
    receipt = {
        "prereg": "MATH-CYBER-1-SVP-FIELD-ORDER-KNOWN-SET-"
                  "HELDOUT-ONSET-SCORE-19001",
        "prereg_commit": "3ac5a70e",
        "seed": 19001,
        "completion_endpoint": {
            "verdict": completion,
    ...
    (OUTDIR / "svpfoheld_receipt.json").write_text(
    ...
    print("[svpfoheld] DONE", flush=True)
    return 0
