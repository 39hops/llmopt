# Generated by: scratch/poly3_pipeline.sh:59 (representative shape for the
#   single-substitution family: gen8_pipeline.sh:45, gen9_pipeline.sh:61,
#   poly3_pipeline.sh:59, poly4_pipeline.sh:59, poly5_pipeline.sh:74 all
#   apply this same one-line data-file swap to scratch/series_probe.py)
# Command: sed "s/series_probe.jsonl/poly3_probe.jsonl/" scratch/series_probe.py > /tmp/poly3_probe.py
# Materialized: 2026-08-12
...
rows = [json.loads(l) for l in open("data/poly3_probe.jsonl")]
preds = []
hit = 0
by_fam = {}
with torch.no_grad():
