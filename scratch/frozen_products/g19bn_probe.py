# Generated by: scratch/g19_bf16_isolation.sh:9-12
# Command: sed -e "s/series_probe.jsonl/series_probe_1e.jsonl/" \
...
model = build_model(len(tok.vocab), d=384, layers=8, ffn=1536, heads=6).to(dev)
model.load_state_dict(torch.load(ckpt, map_location="cpu"))
model.eval()

rows = [json.loads(l) for l in open("data/series_probe_1e.jsonl")]
preds = []
hit = 0
by_fam = {}
with torch.no_grad():
