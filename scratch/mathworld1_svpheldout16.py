"""MATH-CYBER-1 SVP-GRID-HELDOUT-SCORE-16001 — ONE joint strict
heldout scoring run of the two sealed seed-16001 checkpoints on
...
all 96 frozen blocks, including the two FACTOR calibration-miss
...
Outputs under logs/mathworld1/svpheldout16/ (refuse-if-exists):
primary_scores.jsonl, matched_transfer.jsonl,
svpheldout16_receipt.json, robustness_scores.jsonl, riders.json.

    .venv/bin/python scratch/mathworld1_svpheldout16.py      (Mac)
"""
import hashlib
import json
import math
...
CAL_SCORES = "logs/mathworld1/svpcalscore16/scores.jsonl"
CAL_RECEIPT = ("logs/mathworld1/svpcalscore16/"
               "svpcalscore16_receipt.json")
PINS = {
    HELD:
        "a3f6103b3733d909281849dcb3fd6ba9fba3891f2014bec13881"
        "b4509df46ddb",
    CAL_SCORES:
        "1eeb67a94d0281aab47cfc38287d884353891dd5a46ce68a367a"
        "83c3648d943d",
    CAL_RECEIPT:
        "5df7e1ae9f399438b3e7bc2a7e8378200335c9673490965d1fc1"
        "ca687380f420",
...
ARMS = ["FACTOR", "HASH"]
ALPHA = 0.05
OUTDIR = Path("logs/mathworld1/svpheldout16")
TOK = ActionGCTok()
...
def main():
    ...
    receipt = {
        "prereg": "MATH-CYBER-1-SVP-GRID-HELDOUT-SCORE-16001",
        "joint_verdict": joint,
        "endpoint1_absolute": {
    ...
    (OUTDIR / "svpheldout16_receipt.json").write_text(
        json.dumps(receipt, indent=1))
    print(json.dumps({k: receipt[k] for k in
                      ("joint_verdict", "endpoint1_absolute",
                       "endpoint2_matched_transfer",
    ...
    print("[svpheldout16] DONE", flush=True)
    return 0
