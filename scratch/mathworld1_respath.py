"""MATH-CYBER-1 RESIDUAL-PATH-CENSUS-0 — exhaustive 2^8 = 256
whole-block passthrough census (frozen prereg
5b48c02a2c32a1f72f385f4c0e36cbdc279cb73b, RESULTS L61222).

Two frozen seed-19001 checkpoints (CANONICAL / PARAM_FIRST,
...
PREREG_COMMIT = "5b48c02a2c32a1f72f385f4c0e36cbdc279cb73b"
CKPTS = {
...
BOOKED_FULL = {("heldout", "CANONICAL"): 85,
               ...
               ("calibration", "CANONICAL"): 94,
               ("calibration", "PARAM_FIRST"): 93}
...
VOCAB = 340
CODE_BASE = 332
OUTDIR = Path("logs/mathworld1/respath")
TOK = ActionGCTok()
NEAR_FULL_TOL = 2
...
def main():
    ...
    (OUTDIR / "respath_receipt.json").write_text(
