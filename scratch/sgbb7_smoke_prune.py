...
TREES = {"checkpoints/sgbb7_smoke": "logs/sgbb7/smoke.jsonl"}
OUT = Path(f"logs/housekeeping/sgbb7_smoke_prune_inventory_{datetime.date.today().isoformat()}.json")
...
def main():
    ...
    inv = {"kind": "sgbb7_smoke_prune", "direction": "Artin GO 2026-09-11 22:34 EDT (after VERDICT SG-BOUNDARY-BLOCK7-1)", "trees": {}, "mismatch": [], "unreceipted": [], "removed": [], "bytes_freed": 0}
    plan = []
