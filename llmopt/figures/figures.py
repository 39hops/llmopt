...
footer. Light and dark are rendered from the same call.
    ...
    from llmopt.figures.figures import gate_bars
...
from llmopt.figures.figstyle import (CHROME, SERIES_ALLPAIRS, color, figure,
                                 footer, save)
...
def stat(name: str, value: str, label: str, detail: str = "",
    ...
    def build(mode):
        ...
        from llmopt.figures.figstyle import rc
        c = CHROME[mode]
